									...
									<div class="row1">
								        ...
								        <div class="col-md-6">
								        	<div class="row">
												...
												foreach ($products['DATA_LIST'] as $key => $row):
													//remove continue. This is for Testing ricemart only
													// if($this->user['R'] != 'F9175006'){	
													// 	if ($row['ID'] > 183) { continue; }
													// }
												?>
												<div class="col-sm-4 col-md-4 content portfolio-item" style="padding-left: 0px;">
													<div class="panel panel-primary">
													  ...
													  <div class="panel-body" style="font-size: 2vmin 1vmax;">
													  	...
													  	?>
														<a data-toggle="modal" onclick="<?php echo 'modalViewProd(\''.$row['rowid'].'\',\''.$row['product_code'].'\',\''.$row['product_name'].'\',\''.$row['product_desc'].'\',\''.$row['price'].'\',\''.$row['distributor_price'].'\',\''.$row['pv'].'\',\''.$row['status'].'\',\''.$row['inventory'].'\',\''.$row['sold'].'\',\''.'hub'.'\',\''.$discounted_price.'\')'; ?>" style="cursor: pointer;">	
															<img src="<?php echo 'https://mobilereports.globalpinoyremittance.com/assets/images/MLMProducts/'.$row['product_code'].'.jpg' ?>"  style="height:60px; width:100px; background-image: url('https://mobilereports.globalpinoyremittance.com/assets/images/MLMProducts/noimage.jpg'); background-size: 100px; margin:0 auto; display:block;">
										...
										<div class="col-md-6 well">
											...
											<div class="alert alert-danger" id="alertCart" style="display: none; word-wrap:break-word;"></div>
							                    <table class="table table-hover" style="height:230px; overflow:auto;">
							                        <thead>
							                            ...
							                            <th class="animated fadeIn delay050s" nowrap="">Price (SRP)</th>
							                    ...
							                    <table class="table table-hover">
							                        ...
							                        <tbody>
							                           	<tr>
							                                <td>Total Price :</td>
							                                <td><input type="text" id="total-price" readonly class="form-control"/></td>
							                            </tr>
							                            <tr>
							                            	<td>Choose Type:</td>
													  		<td>
														        <label class="radio-inline">
														          <input name="radioGroup" id="distri_type" class="choose_type" value="1" checked="" type="radio" disabled=""> Distributor
														        </label>
														        <label class="radio-inline">
														          <input name="radioGroup" id="walkin_type" class="choose_type" value="2" type="radio" disabled=""> Walkin Purchase
														        </label>
														    </td>
							                            </tr>
							                            <tr>
							                            <form id="form-validate-cart">
							                                ...
							                                <td>
							                                	<input type="text" id="regcode" value="" class="cart_regcode form-control col-md-6" name="regcode" disabled="" />
							                                	<span class="help-inline-error text-danger" style="display:none;">Please input regcode</span>
							                                </td>
							                            </tr>
							                        </tbody>
							                    </table>
							                    <div class="form-group margin-top-small margin-bottom-large pull-right">
													...
													<a href="<?php echo base_url();?>Products/hub_products" class="btn btn-default animated bounceIn delay125s" id="btn-cancelcart" disabled=""><span class="glyphicon glyphicon-remove" aria-hidden="true">Cancel</a>
							                    </div>
