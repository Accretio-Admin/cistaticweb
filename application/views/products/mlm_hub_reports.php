  <div class="mainpanel">
                    ...
                    <div class="contentpanel">
                      ...
                      <?php endif ?>
                     <form method="post" action="<?php echo BASE_URL()?>Products/mlm_hub_reports" id="frmreport">
                          <div class="row">
                            <div class="col-xs-12 col-md-12">
                                ...
                                <div class="col-xs-12 col-md-4">
                                   <div class="form-group">
                                      ...
                                      <a href="<?php echo BASE_URL(); ?>Products/export/<?php echo md5('mlm_hub_reports') ?>" target="_blank">
