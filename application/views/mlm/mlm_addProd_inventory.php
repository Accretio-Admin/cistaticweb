                          ...
                          <div class="row">
                                ...
                                <?php endif ?>
                                  <div class="row" style="margin-bottom: 15px;">
                                      <form method="post" class="form-inline" action="<?php echo BASE_URL() ?>Mlm/mlm_addProd_inventory" id="frmMlm">
                                        <div class="col-lg-6">
                        ...
                        <div class="modal-dialog modal-md" style="margin-top: 100px;">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form class="text-right" method="post" action="<?php echo BASE_URL() ?>Mlm/mlm_addProd_inventory">
