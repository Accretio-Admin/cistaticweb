    ...
    <div class="contentpanel">
        ...
        <form id="RetailerReg" name="RetailerReg">
            <div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 col-lg-6 col-lg-offset-3 col-xl-6 col-xl-offset-3  well" style="margin-top: 1%;" id="RegProcess1">
                ...
                <div class="form-group">
                    <input type="password" class="form-control" name="inputPassword" id="pass1" onkeypress="return validateKeypress(whitespace)" placeholder="Password" required>
                </div>
                <div class="form-group">
                    <input type="password" class="form-control" name="inputCP" id="pass2"  onkeypress="return validateKeypress(whitespace)" placeholder="Confirm Password" onkeyup="checkPassRetailer(); checkMatchRetailer();" required>
                    <span id="confirmMessage" class="confirmMessage"></span>
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" name="inputLN"  id="inputLN" onkeypress="return validateKeypress(alpha)"  onpaste="handlePaste(event, 'inputLN')" placeholder="Last Name" required>
                </div>
                <div class = "form-group">
                    <input type="text" class="form-control" name="inputFN" id="inputFN"  onkeypress="return validateKeypress(alpha)" onpaste="handlePaste(event, 'inputFN')" placeholder="First Name" required>
                </div>
                <div class = "form-group">
                ...
                <div class="form-group">
                    <input type="text" class="form-control" name="inputMD" id="inputMD" onkeypress="return validateKeypress(alpha)"onpaste="handlePaste(event, 'inputMD')" placeholder="Middle Name">
                </div>
                <div class="form-group"> 
                        ...
                        <div class="col-xs-6 col-sm-7 col-md-7">
                            <div class="input-group">
                                <span class="input-group-btn">
                                    <input type="text" class="form-control" name="inputMobileNo" id="regMobile" placeholder="10-Digit Mobile Number" maxlength="10" tabindex="-1" required disabled>
                ...
                <div class="form-group">
                    <div class='row'>
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="input-group">
                                <span class="input-group-btn">
                                    <input type="email" class="form-control" name="inputEmail"  id="inputEmail" onpaste="removeSpaces(event, 'inputEmail')" placeholder="Email Address" onkeypress="return validateKeypress(whitespace)" tabindex="-1"  required>
...
<script>
    var alpha = /[ A-Za-z]/;
    var whitespace = /[\S]$/; 
    var specialCharacters = /^[A-Za-z0-9_~\-!@#\$%\^&*\(\)]+$/;
...
    return validChars.test(keyChar) ? keyChar : false;
    ...
    function handlePaste(event, inputId) {
        ...
        // Remove special characters and numbers from the pasted text
        const strippedText = pastedText.replace(/[^a-zA-Z ]/g, '');

        // Set the modified value to the corresponding input field
        document.getElementById(inputId).value = strippedText;
        }

    function removeSpaces(event, inputId) {
    // Prevent the default paste behavior
    event.preventDefault();
    ...
    const strippedText = pastedText.replace(/\s/g, '');
    ...
    $('#RetailerReg').submit((e) => {
        ...
        waitingDialog.show('Free Registration. Please Wait.', {dialogSize: 'sm', progressType: 'primary'});
            ...
            if($('#btnmobSend').data('timer') != 'START'){
                ...
                $.ajax({   
                    ...
                    {  
                        ...
                        var res = data.split('|'); 
                            console.log("jkasdoksja", res);
                            console.log(data);
                        // if (res[0] == 1 && $("#country").val() !== null) {
                        if (res[0] == 1 && res[1] == "Successfully send!") {
                            //OTP SENT SUCCESS
