<div class="mainpanel">
  ...
  <!--===================================| Built-In |=====================================================-->
      ...
      $(document).ready(function(){//UPSBEA0010|4,UPSWEL004|4
				...
				if(level==7)GetOrders();
				
				GetWallet();
				readCart(); 
				term();
				if(level==7)view('divDisplay','divOrders');
		...
		<div class="row">
			<div class="col-md-12" id="container-cart">
				<div class="w3-green"><b>
					...
					if($user['L']=='7')
					echo'<input type="button" class="w3-button w3-ripple" value="MY CUSTOMER ORDERS" onclick="view(\'divDisplay\',\'divOrders\')"/>';
					?></b>
					<span class="w3-button w3-border-green w3-light-gray w3-border w3-right"/>Voucher 
						<span class="w3-white w3-round w3-border w3-border-green" id="spanPV">&nbsp;0.00&nbsp;</span></span>
					<span class="w3-button w3-border-green w3-light-gray w3-border w3-right"/>GC Points 
						<span class="w3-white w3-round w3-border w3-border-green" style="width:" id="spanGC">&nbsp;0.00&nbsp;</span></span>	
					<span class="w3-button w3-border-green w3-light-gray w3-border w3-right"/>ECash 
						<span class="w3-white w3-round w3-border w3-border-green" style="width:" id="spanECash">&nbsp;0.00&nbsp;</span></span>
				</div>
					...
					<?php  } else { ?> 
						<!--=======================================| Item List |===================================--> 
							...
							<div align="right" style="padding: 10px 20px 20px 0px;">
                                <button class="btn btn-primary btn-blockxx" style="background-color: green;" id="BTNProductCart">
                                    <i class="fa fa-shopping-cart"></i> 
                                    &nbsp; Cart
