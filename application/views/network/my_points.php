        ...
        <div class="tab-content" style="padding: 0px;">
            ...
            <div id="weeklyincome" class="tab-pane fade">
                ...
                <div class="contentpanel">
                    <div class="row row-stat">
                        <div class="col-md-9">
                        <div class="" style="width:100%;height:350px;overflow:auto">
								<table class="table table-striped">
										<thead>
											<tr>
												<th>Remarks</th>	
												...
												<th>Current Right</th>
												<th>Current Left</th>	
												<th>Current Pairing</th>	
												<th>Current Direct</th>	
												<th>Current Indirect</th>	
												<th>Direct Income</th>	
												<th>Indirect Income</th>
												<th>Pairing Income</th>	
												<th>Total GC</th>
												<th>Total Income</th>	
												<th>Date Covered</th>
												<th>Time</th>
											...
											<tbody>
											<?php foreach ($weekly_payout as $w): ?>
												
												<tr>
													<td><?php echo $w['remarks'] ?></td>												
													<td><?php echo $w['waitingRight'] ?></td>
													<td><?php echo $w['waitingLeft'] ?></td>
													<td><?php echo $w['currentRight'] ?></td>
													<td><?php echo $w['currentLeft'] ?></td>
													<td><?php echo $w['currentPairing'] ?></td>
													<td><?php echo $w['currentDirect'] ?></td>
													<td><?php echo $w['currentIndirect'] ?></td>
													<td><?php echo $w['directIncome'] ?></td>
													<td><?php echo $w['indirectIncome'] ?></td>
													<td><?php echo $w['pairingIncome'] ?></td>
													<td><?php echo $w['totalGC'] ?></td>
													<td><?php echo $w['totalIncome'] ?></td>
                    ...
                    <div class="row row-stat">
                        <div class="col-md-8">
				              <table class="table table-striped">
				                ...
				                <tbody>
				                    <?php foreach ($payout_history as $ph): ?>
					                  	<tr>
					                    <!--<td colspan="8" style="font-weight: bold; text-align: center;">NO DATA AVAILABLE!</td> -->
					                    <td><?php echo $ph['amountOrig']; ?></td>
					                    <td><?php echo $ph['amountConverted']; ?></td>
					                    <td><?php echo $ph['availableBalanceBefore']; ?></td>
					                    <td><?php echo $ph['availableBalanceAfter']; ?></td>
					                    <td><?php echo $ph['ecashBalanceBefore']; ?></td>
					                    <td><?php echo $ph['ecashBalanceAfter']; ?></td>
                    ...
                    <div class="row row-stat">
                        <div class="col-md-5">
				              <table class="table table-striped">
				                <thead>
				                  <tr>
				                      <th style="text-align: center">Regcode</th>
				                      <th style="text-align: center">FullName</th>
				                      <th style="text-align: center">Entry Date</th>
				                  </tr>
				                </thead>
				                <tbody>
				                    <?php foreach ($right_downlines as $rd ): ?>
					                  	<tr>
					                    <!--<td colspan="8" style="font-weight: bold; text-align: center;">NO DATA AVAILABLE!</td> -->
					                    <td><?php echo $rd['regcode'] ?></td>
					                    <td><?php echo $rd['fullname'] ?></td>
					                    <td><?php echo $rd['entry_date'] ?></td>
					                  	</tr>
				                  	<?php endforeach ?>
				                </tbody>
				              </table>
                    ...
                    <div class="row row-stat">
                        <div class="col-md-5">
				              <table class="table table-striped">
				                ...
				                <tbody>
				                    <?php foreach ($left_downlines as $ld ): ?>
					                  	<tr>
					                    <!--<td colspan="8" style="font-weight: bold; text-align: center;">NO DATA AVAILABLE!</td> -->
					                    <td><?php echo $ld['regcode'] ?></td>
					                    <td><?php echo $ld['fullname'] ?></td>
					                    <td><?php echo $ld['entry_date'] ?></td>
					                  	</tr>
				                  	<?php endforeach ?>
				                </tbody>
				              </table>
