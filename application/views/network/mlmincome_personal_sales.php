<div class="mainpanel">
    ...
    <div class="contentpanel" style="padding-bottom: 0px;">
        <div class="row row-stat">
            <div class="col-md-9">
                <ul class="nav nav-tabs">
                    ...
                    <li class="active"><a href="<?php echo BASE_URL()?>Network/mlmincome_personal_sales" class="" id="aloading"><span class="glyphicon glyphicon-circle-arrow-left" aria-hidden="true"></span> Sales</a></li>   
        ...
        <div class="tab-content" style="padding: 0px;">
            <div id="personal_sales" class="tab-pane fade in active">
                <!-- <h3>Left Downlines</h3> -->
                <div class="contentpanel">
                    <div class="row row-stat">
                        <div class="col-md-9">
	                        <h3 style="margin-top:0px;">Personal Sales</h3>
	                        
	                        <form method="post" method="<?php echo BASE_URL()?>Network/mlmincome_personal_sales" id="frmreport">
		                        <div class="row">
											...
											<?php if(isset($API['TDATA'])): ?>
												<?php foreach ($API['TDATA'] as $w): ?>
													<tr>
														...
														<td><?php echo $w['trackingno'] ?></td>
														<td><?php echo $w['total_amount'] ?></td>		
														<td><?php echo $w['date_purchased'] ?></td>
													</tr>
												<?php endforeach ?>
											<?php else: ?>
