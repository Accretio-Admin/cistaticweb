<div class="mainpanel">
    ...
    <div class="contentpanel" style="padding-bottom: 0px;">
        <div class="row row-stat">
            <div class="col-md-9">
                <ul class="nav nav-tabs">
                    ...
                    <li class="active"><a href="<?php echo BASE_URL()?>Network/mlmincome_rebates" class="" id="aloading"><span class="glyphicon glyphicon-usd" aria-hidden="true"></span> Rebates</a></li>
        ...
        <div class="tab-content" style="padding: 0px;">       
            <div id="rebates" class="tab-pane fade in active">
                <!-- <h3>Rebates</h3> -->
                <div class="contentpanel">
                    <div class="row row-stat">
                    	<div class="col-md-9">
	                        <h3 style="margin-top:0px;">Rebates</h3>
	                        
                        	<form method="post" method="<?php echo BASE_URL()?>Network/mlmincome_rebates" id="frmreport">
	                          <div class="row">
