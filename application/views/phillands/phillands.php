              ...
              <div class="row gy-5">
                ...
                <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                  ...
                  <div>
                    ...
                    <label for="summTermsCondition">I agree to the <a href="javascript:void(0);" onclick="window.open('<?php echo BASE_URL() ?>phillands/phillands_terms_condition')">Terms and conditions</a></label>
                  </div>
                </div>
              </div>
            </div>
...
<script>
  ...
  $('#formConfirm').submit((e) => {
    ...
    $.ajax({
      url: '/phillands/phillands_transaction',
      type: 'POST',
      data: params,
      success: (data) => {
  ...
  function getAutoComputed () {
    ...
    if ($('#amount').val() && $('#maturity').val()) {
      ...
      $.ajax({
        url: '/phillands/phillands_auto_compute',
        type: 'POST',
        data: params,
        success: (data) => {
          var jsonData = JSON.parse(data)
  ...
  $('#formPayout').submit((e) => {
    ...
    var params = {
      payin_id: payinId,
      trans_pass: $('#payoutSummTransacPass').val()
    }

    $.ajax({
      url: '/phillands/payout_transaction',
      type: 'POST',
      data: params,
      success: (data) => {
