            ...
            <?php foreach ($parameter['occupancies'] as $key => $room) :?>
              <div class="panel panel-default " style="border:0">
                ...
                <div class="panel-body">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-4 col-sm-12 col-xs-12">
                          <div class="form-group">
                            ...
                            <input value="<?php echo isset($post) ? $post['guest'][$key]['adult'][$i]['birthdate']:"" ?>" type="text" class="form-control  fldGuest adultBirthDates" name="guest[<?php echo $key;?>][adult][<?php echo $i;?>][birthdate]" id="adultBDay<?php echo $i;?>" placeholder="YYYY-MM-DD" required data-tag="<?php echo "r{$key}A{$i}"?>" data-type='<?php echo json_encode(["r"=>$key,"type"=>"adult","key"=>$i])?>' data-content="birthdate" readonly style="cursor:pointer" autocomplete="anyrandomstring6">
                          </div>
                        </div>
                    ...
                    <script>
                    $(function() {
                      $('input[class*="adultBirthDates"]').daterangepicker({
