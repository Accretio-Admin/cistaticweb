                                   ...
                                   <tr class="trPNR">
                                    ...
                                    <?php 
                                       ...
                                       if ($t['BS'] == "To Deliver"): ?>
                                        ...
                                        <?php else:?>
<!--                                             <td><a onclick="return confirm('Check Status?','Domestic Ticketing Transactions')" href="<?php echo BASE_URL() ?>Merged_ticketing/eticketing/<?php echo $t['tn'] ?>" class="btn btn-primary"  id="aPNR" data-toggle="tooltip" title="Click here to check status"><?php echo 'Check Status' ?></a></td> -->
                                          ...
                                          <?php } else if ($t['provider']=='BYAHEKO' || $t['provider']=='byaheko') { ?>  
                                            <td><a onclick="return confirm('Check Status?','Domestic Ticketing Transactions')" href="<?php echo BASE_URL() ?>Merged_ticketing/eticketing/2/<?php echo $t['tn'] ?>" class="btn btn-primary"  id="aPNR" data-toggle="tooltip" title="Click here to check status"><?php echo 'Check Status' ?></a></td>
                                          
                                          <?php } else { ?> 
                                            <td><a onclick="return confirm('Check Status?','Domestic Ticketing Transactions')" href="<?php echo BASE_URL() ?>Merged_ticketing/eticketing/1/<?php echo $t['tn'] ?>" class="btn btn-primary"  id="aPNR" data-toggle="tooltip" title="Click here to check status"><?php echo 'Check Status' ?></a></td>
                                          <?php } ?>
...
<div id="myModal1" class="modal fade" role="dialog">
  <div class="modal-dialog">
    <form action="<?php echo BASE_URL() ?>Merged_ticketing/eticketing" method="post" class="loading modal_loading" id="frmEticketsCon">
      <!-- Modal content-->
