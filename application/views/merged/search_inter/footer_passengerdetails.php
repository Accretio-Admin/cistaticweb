...
<script>
    ...
    angular.module('myApp', [])
        .controller('myCtrl', ['$scope', function($scope) {
            ...
            $scope.startDate = {
                "adt" : moment().subtract(12,'year').format('MM/DD/YYYY'),
                "src" : moment().subtract(12,'year').format('MM/DD/YYYY'),
                "cnn" : moment().subtract(2,'year').format('MM/DD/YYYY'),
                "inf" : moment().format('MM/DD/YYYY')
            };
