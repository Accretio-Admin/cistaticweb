...
<script>
    ...
    /*INSERT NEW ID */
    $(".btnUploadSeniorID").change(function(){
        ...
        waitingDialog.show('Please Wait..', {dialogSize: 'sm', progressType: 'primary'});
          ...
          $("#seniorIdImg"+number).val('');
    
          var fileInput = document.getElementById('fileseniorid'+number);   
          ...
          if (file == "" || file == undefined) {
            ...
            formData.append('type', 'SENIORID');
            formData.append('requestid', requestid);
            formData.append('number', number);

            $.ajax({
                url: "/Merged_ticketing/add_newid_payout",
                type: 'POST',
                // data: parameters,
                data: formData,
                async: false,
                ...
                success: function (data) {
                    ...
                    if(jsondata.S != 1){
                        $("#uploadmessage"+number).html('Senior ID '+jsondata.M);
                        $("#uploadmessage"+number).last().addClass( "alert alert-success" );
                        $("#uploadmessage"+number).show();
                        $("#seniorIdImg"+number).val(jsondata.A);
                        ...
                        //validate begin: 
                          ...
                          while(x < uploadcount){
                            ...
                            var seniorIdImgVal = $("#seniorIdImg"+x).val();
