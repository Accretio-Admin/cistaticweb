...
<!--                                        <input type="checkbox" name="senior" value="1" id="activate_senior" ng-model="ModelData.Seniors"/>&nbsp;Senior Citizen [60 yrs and above]-->
                                ...
                                <div class="form-group col-md-12 text-justify" id="seniornotes" ng-show="ModelData.Seniors">
                                    ...
                                    <p class="text-danger"><b class="text-danger"><u>Uploading of  OSCA or any valid government issued ID showing both Filipino Citizenship and Date of Birth will be required </u></b> by the system upon choosing the Senior Citizen.</p>
