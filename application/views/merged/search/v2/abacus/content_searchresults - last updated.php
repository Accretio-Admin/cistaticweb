...
<!--                                {{passenger}}-->
                                <div ng-repeat="(_index,itinerary) in itineraries" class="list-group-item hover {{(data['Passengers']['Senior']>0&&_provider=='abacus')?'disabled displaynone':'wlaPass'}} {{(itinerary['Flights'][0]['Carrier']=='Philippine Airlines'&&_provider=='via')?'disabled displaynone':''}} {{chosen_onward['index']=='-1'?'meron1':'wala1'}} {{chosen_onward['index']==_index?'ok':'di'}}" style="margin-top: 10px;}"
                            ...
                            <div class="list-group">
                                <div>
                                    <div ng-repeat="(_provider,itineraries) in data['results_return']">
                                        <div ng-repeat="(_index,itinerary) in itineraries" class="list-group-item {{(data['Passengers']['Senior']>0&&_provider=='abacus')?'disabled displaynone':'wlaPass'}} {{(itinerary['Flights'][0]['Carrier']=='Philippine Airlines'&&_provider=='via')?'disabled displaynone':''}} {{(chosen_onward['provider']!=''&&chosen_onward['index']>=0)?'hover':''}} {{chosen_onward['provider']!=''&&chosen_onward['provider']!=_provider?'disabled displaynone':''}}" style="margin-top: 10px;}"
                                            ...
                                            <table class="alfonzo">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div>
                                                            <button type="button" class="btn btn-primary btn-sm btn-block {{(data['Passengers']['Senior']>0&&_provider=='abacus')?'disabled':''}} {{(itinerary['Flights'][0]['Carrier']=='Philippine Airlines'&&_provider=='via')?'disabled':''}} {{chosen_onward['provider']==''?'disabled': (chosen_return['provider']==_provider&&chosen_return['index']==_index)?'disabled':'';}}"
