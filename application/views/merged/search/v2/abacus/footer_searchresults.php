...
<script>
    angular.module('myApp', [])
        ...
        .controller('myCtrl', ['$anchorScroll', '$location', '$scope', function($anchorScroll, $location, $scope) {
            ...
            $scope.addHourAllowance = function(str){
                arr = str.split('T');
                t = arr[1].substr(2,4);
                addTime = moment(str).add(6, 'hours').add(t, 'minutes');
                return addTime.format('YYYY-MM-DDTHHmm');
            }
            ...
            $scope.arrivalTime = function(arrivalTime) {
                // alert(arrivalTime);
                arrivalTimeData = arrivalTime.split("T")[1];
                arrivalDateData = arrivalTime.split("T")[0];
                $scope.aTime = [{aTime: arrivalTimeData, aDate: arrivalDateData}];
                $scope.aDate = [arrivalTimeData];
                return $scope.aTime
            };
            
            $scope.clearArrivalTime = function() {
                $scope.aTime = "";
            }
