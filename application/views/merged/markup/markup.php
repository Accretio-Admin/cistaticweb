                ...
                <div class="contentpanel" style="padding-top: 0px;">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <?php if ($output['S'] === 0): ?>
                                <div class="alert alert-danger"><?php  echo $output['M'] ?> </div>
            ...
            <div class="col-md-5">
                <div class="form-group">
                    <div class="alert alert-info alert-biller-default" style="word-wrap:break-word;">
                        ...
                        <p> <b><span class="text-info1">Note:</span></b> The maximum markup price for Domestic Flight is <b> PHP 500.00 </b></p>
                    </div>
                </div>
            </div>
        </div>
...
<div class="modal fade" id="updateMarkup" role="dialog" >
    <div class="modal-dialog modal-sm">
        ...
        <div class="modal-content modal-content-xs">
            ...
            <form action="<?php echo BASE_URL() ?>Merged_ticketing/markup" method="post" id="frmDomesticMarkup">
