                            ...
                            <div class="col-xs-12 col-md-12">
                                ...
                                <div class="form-group">
                                     <select class="form-control" name="selEcash">
                                            ...
                                            <option value="6" <?php echo $_POST["selEcash"] == '6' ? 'selected':''?> >E-CASH TO SMARTMONEY</option>
                                            <option value="8" <?php echo $_POST["selEcash"] == '8' ? 'selected':''?> >E-CASH TO WESTERN UNION (SEND)</option>
                                            <option value="9" <?php echo $_POST["selEcash"] == '9' ? 'selected':''?> >E-CASH TO GCASH</option>
                                            <option value="10" <?php echo $_POST["selEcash"] == '10' ? 'selected':''?> >E-CASH TO PAYMAYA</option>
                                                  ...
                                                  <tbody>
                                                      ...
                                                      <?php endforeach ?>
                                                       ...
                                                       <?php if ($TBODY == 6): ?>
                                                         <?php foreach ($API['TDATA'] as $r): ?>
                                                          <tr>
                                                              <td>
                                                                <?php if($r['status'] == "APPROVED") : ?><a href="https://mobilereports.globalpinoyremittance.com/portal/ecash_to_paymaya_receipt/<?php echo $r['trackingNumber'];?>" target="_blank"><?php echo $r['trackingNumber'];?></a><?php endif ?>
                                                                <?php if($r['status'] != "APPROVED") : ?><?php echo $r['trackingNumber'];?><?php endif ?>
                                                              </td>
                                                              <td><?php echo $r['regcode'];?></td>
                                                              ...
                                                              <td><?php echo $r['amount'];?></td>
                                                              <td><?php echo $r['charge'];?></td> 
                                                              <td><?php echo number_format($r['amount'] + $r['charge'], 2, '.', '');?></td>
                                                              <td>
                                                                <?php if($r['status'] != "APPROVED" && $r['status'] != "OTP") : ?><?php echo $r['remarks'];?></a><?php endif ?>
                                                                <?php if($r['status'] == "APPROVED") : ?><?php echo $r['status'];?><?php endif ?>
                                                                <?php if($r['status'] == "OTP") : ?><?php echo $r['status'];?><?php endif ?>
                                                              </td>
                                                              
                                                              <td><?php echo $r['balanceBefore'];?></td>
                                                              <td><?php echo $r['balanceAfter'];?></td>
                                                   ...
                                                   <!-- Cardless Padala - Harry -->
                                                      ...
                                                      <?php endforeach ?>
                                                       <?php endif ?>
                                                        ...
                                                        <?php if ($TBODY == 8): ?>
                                                         <?php foreach ($API['TDATA'] as $r): ?>
                                                            <tr>
                                                             <td><?php echo $r['referenceNumber'];?></td>
                                                             <?php if ($r['status'] == 'DONE'): ?>
                                                              <td><a href="<?php echo $r['WU_URL']?>" target = "_blank"><?php echo $r['trackingNumber'];?></a></td>
                                                             <?php else: ?>
                                                              <td><?php echo $r['trackingNumber'];?></td>
                                                             <?php endif; ?>
                                                             <td><?php echo $r['sender_name'];?></td>
                                                             <td><?php echo $r['ttype'];?></td>
                                                             <td><?php echo number_format($r['amount'],2);?></td>
                                                             <td><?php echo number_format($r['charge'],2);?></td>
                                                      ...
                                                      <!-- end Cardless Padala - Harry -->
                                                        ...
                                                        <?php if ($TBODY == 9 || $TBODY == 10): ?>
                                                         <?php foreach ($API['TDATA'] as $r): ?>
                                                            <tr>
                                                             <?php if ($r['status'] == 'DONE'): ?>
                                                              <td><a href="<?php echo $r['receipt_url']?>" target = "_blank"><?php echo $r['trackingno'];?></a></td>
                                                             <?php else: ?>
                                                              <td><?php echo $r['trackingno'];?></td>
                                                             <?php endif; ?>
                                                             <td><?php echo $r['first_field'];?></td>
                                                             <td><?php echo $r['second_field'];?></td>
                                                             <td><?php echo number_format($r['amount'],2);?></td>
                                                             <td><?php echo number_format($r['charge'],2);?></td>
                                                             <td><?php echo number_format($r['total_amount'],2);?></td>
                                                             <td><?php echo $r['status'];?></td>
                                                             <td><?php echo $r['reference_no'];?></td>
                                                             <td><?php echo $r['processtime'];?></td>
                                                            </tr>
                                                         <?php endforeach ?>
                                                        <?php endif; ?>
