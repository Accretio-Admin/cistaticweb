                    ...
                    <div class="pageheader">
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <h4>AED FUND REPORT</h4>
                            </div>
                        </div><!-- media -->
                    </div><!-- pageheader -->
                    <div class="contentpanel">
                     <form method="post" action="<?php echo BASE_URL()?>Report/aed_fund" id="frmreport" >
                          <div class="row">
                            <div class="col-xs-12 col-md-12">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-4 text-left">
                                      ...
                                      <button type="submit" name="btnSearch" class="btn btn-primary"><i class="glyphicon glyphicon-search"></i>&nbsp;SEARCH</button>
                                       <a href="<?php echo BASE_URL(); ?>Report/export/<?php echo md5('aed_fund_report') ?>" target="_blank">
