                    ...
                    <div class="pageheader">
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <h4>QATAR FUND REPORT</h4>
                            </div>
                        </div><!-- media -->
                    </div><!-- pageheader -->
                    <div class="contentpanel">
                     <form method="post" action="<?php echo BASE_URL()?>Report/qatar_fund" id="frmreport" >
                          <div class="row">
                            <div class="col-xs-12 col-md-12">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-4 text-left">
                                      ...
                                      <button type="submit" name="btnSearch" class="btn btn-primary"><i class="glyphicon glyphicon-search"></i>&nbsp;SEARCH</button>
                                       <a href="<?php echo BASE_URL(); ?>Report/export/<?php echo md5('qatar_fund_report') ?>" target="_blank">
                                           ...
                                           <table class="table table-bordered" style="width:auto;">
                                                  ...
                                                  <tbody>
                                                       <?php if ($TBODY == 1): ?>
                                                         ...
                                                         <?php foreach ($API['TDATA'] as $aed): ?>
                                                          <tr>
                                                              <td><?php echo $aed['controlno'];?></td>
                                                              <td><?php echo $aed['mobileno'];?></td>
                                                              <td><?php echo $aed['plancode'];?></td>
                                                              <td><?php echo $aed['transtype'];?></td>
                                                              <td><?php echo $aed['refno'];?></td>
                                                              <td><?php echo $aed['trackingno'];?></td>
                                                              <td><?php echo $aed['amount'];?></td>
                                                              <td><?php echo $aed['forex'];?></td>
                                                              <td><?php echo $aed['retail'];?></td>
                                                              <td><?php echo $aed['debit'];?></td>
                                                              <td><?php echo $aed['profit'];?></td>
                                                              <td><?php echo $aed['credit'];?></td>
                                                              <td><?php echo $aed['balance'];?></td>
                                                              <td><?php echo $aed['transDate'];?></td>
                                                           </tr>   
                                                         <?php endforeach ?>
                                                       <?php endif ?>
