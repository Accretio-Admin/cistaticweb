  ...
  ?>
                     ...
                     <form method="post" action="<?php echo BASE_URL()?>Report/sgd_fund" id="frmreport" >
                          <div class="row">
                            <div class="col-xs-12 col-md-12">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-4 text-left">
                                      ...
                                      <a href="<?php echo BASE_URL(); ?>Report/export/<?php echo md5('sgd_fund_report') ?>" target="_blank">
