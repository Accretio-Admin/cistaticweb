  ...
  <div class="contentpanel">
    <div class="row">
      ...
      <div class="col-xs-12 col-md-12">
        <form action="<?php echo BASE_URL()."report/hotel_reports"?>" method="POST">
        <div class="row">
        <div class="col-xs-12 col-md-12">
        ...
        <div class="col-md-6">
          <div class="form-group">
            <div class="col-xs-12 col-md-12 col-lg-5 col-sm-6"> 
              <div class="row">
                  ...
                  <div class="panel-body" style="height: 600px;overflow: scroll;" >
                    <div class="row">
                      <table class="table table-bordered">
                        <thead>
                          <tr nowrap>
                            <th nowrap>Status</th>
                              ...
                              <th nowrap>Balance Before</th>
                              <th nowrap>Balance After</th>
                            </tr>
                        </thead>
                        ...
                        <tbody>
                          ...
                          if (count($results)):
                            ...
                            <tr>
                              <td width="10%">
                                <a id="aPNR" class="btn btn-warning" href="https://mobilereports.globalpinoyremittance.com/portal/hotel_voucher/<?php echo $result['trackingNumber']?>" target="_blank" data-toggle="tooltip" title="Click here get receipt">Get Voucher</a>
                              </td>
                              <!-- <td width="3%"><?php echo $result['id']?></td> -->
                              <td width="10%"><?php echo $result['trackingNumber']?></td>
                              <td width="10%"><?php echo $result['referenceNumber']?></td>
                            ...
                            <td width="6%"><?php echo number_format($result['balanceBefore'])?></td>
                            <td width="6%"><?php echo number_format($result['balanceAfter'])?></td>
                            </tr>
                          <?php
                          endforeach;
                        else:?>
                      ...
                      <?php endif;
                        ...
                        //   '
                        //   <tr>
                        //       <td colspan="15" style="text-align: center;"><span ><b>Please search for reports</b></span></td>
                        //     </tr>
                        //   ';
                        // }
                        ?>
