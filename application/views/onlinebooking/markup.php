                    ...
                    <div class="panel-heading" style="padding-top: 15px; padding-bottom: 0px; color: #4169E1; font-weight: bold;">MARKUP</div>
                      <div class="panel-body">
                        ...
                        <?php elseif ($output['S'] == 1): ?>
                            <div class="alert alert-sucess"><?php  echo $output['M'] ?> </div>
                        <?php endif ?>
                        <form name="frmiremit" action="<?php echo BASE_URL() ?>Domestic_flights/markup" method="post" id="frmDomesticMarkup">
...
<div class="modal fade" id="updateMarkup" role="dialog" >
  <div class="modal-dialog modal-sm">
    ...
    <div class="modal-content modal-content-xs">
      ...
      <form action="<?php echo BASE_URL() ?>Domestic_flights/markup" method="post" id="frmDomesticMarkup">
