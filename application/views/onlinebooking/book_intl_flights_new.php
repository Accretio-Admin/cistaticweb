                                        ...
                                        <div class="follower-list">  
                                            <div class="col-sm-12">
                                                <div class="row media-manager">
                                                    ...
                                                    <!-- <button class="loadx" onclick="handleWindowClose('tets')">Click me</button> -->
                                                    <!-- <button class="load">Click me</button> -->
                                                      ...
                                                      <div class="row">
                                                              ...
                                                              <?php if ($process === 0): ?>
                                                                <div class="col-xs-12 col-md-5 well">
                                                                  ...
                                                                  <div class="alert alert-success">
                                                                    ...
                                                                    <p><strong>TRANSACTION NUMBER:</strong>&nbsp;<a target="_blank" href="<?php echo $output['URL'].$output['TN']; ?>"><?php echo $output['TN']; ?></a></p><p><i><small>Click transaction number to download reciept.</small></i></p>
                                                                  </div>
                                                                  <?php endif ?>
                                                                  <?php if ($output['S'] === 0): ?>
                                                                  ...
                                                                  <?php endif ?>
                                                                    <form action="<?php echo BASE_URL()?>Merged_intl_flights_new/book_international_flights" method="post" id="frmInternationalFlights">
                                                              ...
                                                              <div class="col-xs-12 col-md-7">
                                                                <div class="panel panel-default">
                                                                  ...
                                                                  <div class="panel-body">
                                                                    ...
                                                                    <p>Please ensure to submit any of the required document immediately upon ticket issuance (within one (1) hour of booking) to ticketingsupport@mygprs.ph.  Bookings will auto-abort in case of failure to submit required travel documents.</p>
                                                            ...
                                                            <?php elseif ($process === 1): ?>
                                                                ...
                                                                <?php endif ?>
                                                                    <form action="<?php echo BASE_URL()?>Merged_intl_flights_new/book_international_flights" method="post" class="transaction_form" id="frmInternationalFlights">
...
" style="color:#04547C; cursor: pointer;">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-xs-12 col-md-12">
                                                                                <a href="<?php echo BASE_URL(); ?>Merged_intl_flights_new/book_international_flights">
...
<!--                                                                 <div class="col-md-3  alert alert-info gradient">
                                                                    ...
                                                                    <form action="<?php echo BASE_URL()?>Merged_intl_flights_new/book_international_flights" method="post" class="transaction_form" id="frmInternationalFlights">
                                                                      ...
                                                                      <hr style="margin-top: 0px;">
                                                                        ...
                                                                        <table class="table">
                                                                          <tbody>
                                                                            <tr>
                                                                                <th colspan="4" style="border-top: ; color: #4169E1;">Contact & Delivery Details</th>
                                                                            </tr>
                                                                            <tr class="pad10">
                                                                                <td colspan="1">
                                                                            ...
                                                                            <tr>
                                                                              <td colspan="8" style="">
                                                                                  ...
                                                                                  <button name="btnBookFlights" id="btnBookFlights" class="btn btn-primary pull-right" disabled="">Next&nbsp;<span class="glyphicon glyphicon-arrow-right"></span></button>
                                                                              </td>
                                                                            </tr>
                                                                          </tbody>
                                                                        </table>
                    ...
                    <?php if ($process ===3 ): ?>
                      <div class="row">
                        ...
                        <div class="list-group">
                            <div class="list-group-item">
                                <h4 style="font-weight: bold; color: #4169E1;">Contact & Delivery Details</h4>
                                <table class="table">
                                  <thead>
                            ...
                            <div class="list-group-item">
                                ...
                                <table class="table">
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      <td colspan="4">
                                          <form method="post" action="<?php echo BASE_URL()?>Merged_intl_flights_new/book_international_flights" class="transaction_form" id="frmInternationalFlights">
                                              ...
                                              <div id="myModalCancel" class="modal fade" role="dialog">
                                                <div class="modal-dialog">
                                                  ...
                                                  <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                      <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                                      <a class="btn btn-primary" href="<?php echo BASE_URL()?>Merged_intl_flights_new/book_international_flights">Proceed&nbsp;<span class="glyphicon glyphicon-arrow-right"></span></a>
                                                    </div>
                                                  </div>
                                                </div>
                                              </div>  
