                                   ...
                                   <tr class="trPNR">
                                    ...
                                    <?php 
                                       ...
                                       if ($t['BS'] == "To Deliver"): ?>
                                        ...
                                        <?php else:?>
                                        <td><a onclick="return confirm('Check Status?','International Ticketing Transactions')" href="<?php echo BASE_URL() ?>International_flights/eticketing_international/<?php echo $t['tn'] ?>"class="btn btn-primary" id="aPNR" data-toggle="tooltip" title="Click here to check status"><?php echo 'Check Status' ?></a></td>
                                       <?php endif; 
                                     }
                                     ?>
                                      <td><?php echo $t['tn'] ?></td>
