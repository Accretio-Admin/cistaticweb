                  ...
                  <div class="panel panel-default">
                    <div class="panel-heading" style="padding-top: 15px; padding-bottom: 0px; color: #4169E1; font-weight: bold;">MARKUP</div>
                      <div class="panel-body">
                        ...
                        <?php endif ?>
                        <form name="frmiremit" action="<?php echo BASE_URL() ?>Merged_intl_flights/markup_international" method="post" id="frmInternationalMarkup">
            ...
            <div class="col-md-5">
                <div class="form-group">
                    <div class="alert alert-info alert-biller-default" style="word-wrap:break-word;">
                        ...
                        <p> <b><span class="text-info1">Note:</span></b> The maximum markup price for International Flight is <b> PHP 1,000.00 </b></p>
                    </div>
                </div>
            </div>
        </div>
...
<div class="modal fade" id="updateMarkup" role="dialog" >
  <div class="modal-dialog modal-sm">
    ...
    <div class="modal-content modal-content-xs">
      ...
      <form action="<?php echo BASE_URL() ?>Merged_intl_flights/markup_international" method="post" id="frmInternationalMarkup">
