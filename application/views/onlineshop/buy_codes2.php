...
<!--                                                       <div class="row">
                                                      ...
                                                      <div class="row">
                                                        ...
                                                        <a href="#" id="buycodelink1" data-desc="Global Dealer Package" >
                                                          <div class="thumbnail">
                                                            ...
                                                            <div class="caption">
                                                              ...
                                                              <p style="text-align: center"><b>Net Price:</b> &#8369 <?php echo number_format($result['N1'],2)?></p>
                                                        ...
                                                        <a href="#" id="buycodelink2" data-desc="Pinoy Dealer Package" >
                                                          <div class="thumbnail">
                                                            ...
                                                            <div class="caption">
                                                              ...
                                                              <p style="text-align: center"><b>Net Price:</b> &#8369 <?php echo number_format($result['N2'],2)?></p>
                                                                  <p>  1. Loading <br />
                                                        ...
                                                        <p style="color: #4CA6FF;"><i><b>IMPORTANT: Please Read</b></i>
                                                        <br/> * All registration/activation codes will be sent to the buyer's email address
                                                        <br/> * Please verify if the email of the client is valid and working.
                                                        <br/> * Charges per country will vary, please select the approriate country.
                                                        </p>
                                                        </div>
                                                      </div>
                                                      <!--THUMBNAIL-->
                    ...
                    <!-- Modal -->
                      <div class="modal fade" id="buycodemodal" role="dialog">
                        <div class="modal-dialog">
                          ...
                          <form action ="<?php echo BASE_URL()?>Online_shop2/buy_codes" method="post">
                            ...
                            <div class="modal-body">
                                  ...
                                  <input type="text" class="form-control" name ="inputCountry" id="inputCountry" value="<?php echo $result['CNAME']?>" readonly />
                                  </div>
                                  <div class="form-group">
