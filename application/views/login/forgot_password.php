          ...
          <div>
            <form action="<?php echo BASE_URL(); ?>Login/forgot_password" method="post" id="frmforgotpassword">
              <div class="row">
                ...
                <div class="col-md-12">
                  <button type="submit" class="login-button" style="cursor: pointer;" name="btnForgot">
                   Submit
                  </button>
                </div>

                <div class="col-md-12">
                  <button type="button" class="login-back-button" style="cursor: pointer;" name="btnBack" onclick="window.location.replace('<?php echo BASE_URL() ?>Login/')">
                    Back
                  </button>
                </div>
              </div>
