                ...
                <div class="follower-list">  
                  <div class="col-sm-12">
                    <div class="row media-manager">
                      ...
                      <?php if ($user['A_CTRL']['fundrequest'] == 1 || $user['A_CTRL']['fund_request'] == 1 && $user['A_CTRL']['fund_request_AED'] == 1): ?>
                        <div class="col-xs-6 col-sm-4 col-md-4 document">
                          <div class="thmb">
                            <?php if ($exceed_aed == 1): ?>
                              <div class="thmb-prev">
                            ...
                            <?php else: ?>
                              ...
                              <h5 class="fm-title text-center"><a onclick="alert('You have exceeded the transaction limit for this day.')">AED FUND</a></h5>
                            <?php endif ?>
                          </div>
                        </div>
                      <?php endif ?> 
                          
                      <?php if ($user['A_CTRL']['fundrequest'] == 1 || $user['A_CTRL']['fund_request'] == 1 && $user['A_CTRL']['fund_request_QAR'] == 1): ?>  
                        <div class="col-xs-6 col-sm-4 col-md-4 document">
                          <div class="thmb">
                            <?php if ($exceed_qar == 1): ?>
                              <div class="thmb-prev">
                            ...
                            <?php else: ?>
                              ...
                              <h5 class="fm-title text-center"><a onclick="alert('You have exceeded the transaction limit for this day.')">QATAR FUND</a></h5>
                            <?php endif ?>
                          </div>
                        </div> 
                      <?php endif ?>
                      ...
                      <?php if ($user['A_CTRL']['fundrequest'] == 1 || $user['A_CTRL']['fund_request'] == 1 && $user['A_CTRL']['fund_request_HKD'] == 1): ?>
                        <div class="col-xs-6 col-sm-4 col-md-4 document">
                          <div class="thmb">
                            <?php if ($exceed_hkd == 1): ?>
                              <div class="thmb-prev">
                            ...
                            <?php else: ?>
                              ...
                              <h5 class="fm-title text-center"><a onclick="alert('You have exceeded the transaction limit for this day.')">HKD FUND</a></h5>
                            <?php endif ?>
                          </div>
                        </div>
                      <?php endif ?> 

                      <?php if ($user['A_CTRL']['fundrequest'] == 1 || $user['A_CTRL']['fund_request'] == 1 && $user['A_CTRL']['fund_request_ForexEcash'] == 1): ?>
                        <div class="col-xs-6 col-sm-4 col-md-4 document">
                          <div class="thmb">
                            <?php if ($exceed_forex == 1): ?>
                              <div class="thmb-prev">
                            ...
                            <?php else: ?>
                              ...
                              <h5 class="fm-title text-center"><a onclick="alert('You have exceeded the transaction limit for this day.')">FOREX ECASH TRANSFER</a></h5>
                            <?php endif ?>
                          </div>
                        </div>
                      <?php endif ?> 

                      <?php if ($user['A_CTRL']['fundrequest'] == 1 || $user['A_CTRL']['fund_request'] == 1 && $user['A_CTRL']['fund_request_SGD'] == 1): ?>
                        <div class="col-xs-6 col-sm-4 col-md-4 document">
                          <div class="thmb">
                            <?php if ($exceed_sgd == 1): ?>
                              <div class="thmb-prev">
                            ...
                            <?php else: ?>
                              ...
                              <h5 class="fm-title text-center"><a onclick="alert('You have exceeded the transaction limit for this day.')">SGD FUND</a></h5>
                            <?php endif ?>
                          </div>
                        </div>
                      <?php endif ?> 

                      <?php if ($user['A_CTRL']['fundrequest'] == 1 || $user['A_CTRL']['fund_request'] == 1 && $user['A_CTRL']['fund_request_MYR'] == 1): ?>
                        <div class="col-xs-6 col-sm-4 col-md-4 document">
                          <div class="thmb">
                            <div class="thmb-prev">
