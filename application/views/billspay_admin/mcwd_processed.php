                      ...
                      <div class="col-lg-12"> 
                        <div class="row" style="margin-bottom: 30px;">
                          <ul class="nav nav-tabs">
                            <li><a href="<?php echo BASE_URL()?>billspay_admin/mcwd_approval">PENDING</a></li> 
                            <li class="active"><a href="<?php echo BASE_URL()?>billspay_admin/mcwd_processed" style="color: #428bca;"><b>PROCESSED</b></a></li>   
                          </ul>
                        </div>
                      </div>
                      ...
                      <div class="col-lg-12"> 
                        ...
                        <div class="alert alert-danger" id="alertDanger" style="display: none;"></div>
                          <div class="row" style="margin-bottom: 15px;">
                              <form method="post" class="form-inline" action="<?php echo BASE_URL() ?>billspay_admin/mcwd_processed" id="frmBuycodes">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group text-left">
                                        <button type="submit" name="btn_search" class="btn btn-primary"><i class="glyphicon glyphicon-search"></i>&nbsp;SEARCH</button>
                                         <a href="<?php echo BASE_URL(); ?>billspay_admin/export/mcwd_processed_report" target="_blank">
                          ...
                          <div class="table-responsive">
                              <table class="table table-bordered table-hover productTable">
                                ...
                                <tbody>
                                    <?php $count1 = 1; foreach ($results['P_DATA'] as $row): ?>
                                      <tr class="prod_row">
