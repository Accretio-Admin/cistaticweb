                                                                ...
                                                                <?php if (is_null($process)): ?>
                                                                    <div class="col-xs-6 col-md-5">
                                                                      <form method="post" action="<?php echo base_url('/Einsurance/malayan_insurance') ?>" class="transaction_form" id="frmMalayan">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <input type="text" class="form-control inputNameLimit" name="inputFname" placeholder="FirstName" required />
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <input type="text" class="form-control inputNameLimit" name="inputMname" id="inputMnameEnsurance" placeholder="MiddleName" required  />
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <input type="text" class="form-control inputNameLimit" name="inputLname" id="inputLnameEnsurance" placeholder="LastName" required  />
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <input type="text" class="form-control" id="datetimepicker" name="inputBdate" placeholder="Insured Birthdate" required readonly />
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <input type="text" class="form-control" name="inputOccup" placeholder="Insured Occupation" required  />
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <input type="email" class="form-control" name="inputEmail" placeholder="Insured Email Address" required  />
                                                                        </div>
                                                                        <hr />
                                                                        <div class="form-group">
                                                                            <input type="text" class="form-control inputNameLimit" name="inputbFname" placeholder="Benificiary FirstName" required />
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <input type="text" class="form-control inputNameLimit" name="inputbMname" id="inputBMnameEnsurance" placeholder="Benificiary MiddleName" required  />
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <input type="text" class="form-control inputNameLimit" name="inputbLname" id="inputBLnameEnsurance" placeholder="Benificiary LastName" required  />
                                                                        </div>
                                                                        <hr />
                                                                        <div class="form-group text-right">
                                                                            <button type="submit" class="btn btn-primary" name="btn_submit_malayan" id="btnContinueEnsurance" disabled="">Continue <span class="glyphicon glyphicon-share-alt" aria-hidden="true"></span></button>
                                                                        </div>
                                                                      </form>
                                                                    </div>
                                                                    ...
                                                                    <form method="post" action="<?php echo base_url('/Einsurance/malayan_insurance') ?>" id="frmMalayan">
                                                                        <div class="form-group">
                                                                            <div class="input-group">
                                                                                ...
                                                                                <input type="text" class="form-control inputNameLimit" name="inputFname" value="<?php echo $info['fname'] ?>" readonly />
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <div class="input-group">
                                                                                <span class="input-group-addon" id="basic-addon1" style="padding-right: 76px;">Middle Initial: &nbsp;</span>
                                                                                <input type="text" class="form-control inputNameLimit" name="inputMname" value="<?php echo $info['mname'] ?>" readonly  />
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <div class="input-group">
                                                                                <span class="input-group-addon" id="basic-addon1" style="padding-right: 90px;">LastName: &nbsp;</span>
                                                                                <input type="text" class="form-control inputNameLimit" name="inputLname" value="<?php echo $info['lname'] ?>" readonly  />
                                                                            </div>
                                                                        </div>
                                                                        <hr />
                                                                        <div class="form-group">
                                                                            <div class="input-group">
                                                                                ...
                                                                                <input type="text" class="form-control inputNameLimit" name="inputbFname" value="<?php echo $info['bfname'] ?>" readonly />
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <div class="input-group">
                                                                                <span class="input-group-addon" id="basic-addon1" style="padding-right: 65px;">Benificiary MiddleName: &nbsp;</span>
                                                                                <input type="text" class="form-control inputNameLimit" name="inputbMname" value="<?php echo $info['bmname'] ?>" readonly  />
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <div class="input-group">
                                                                                <span class="input-group-addon" id="basic-addon1" style="padding-right: 20px;">Benificiary LastName: &nbsp;</span>
                                                                                <input type="text" class="form-control inputNameLimit" name="inputbLname" value="<?php echo $info['blname'] ?>" readonly  />
                                                                            </div>
                                                                        </div>
                                                                        <hr />
                                                                        <div class="form-group">
