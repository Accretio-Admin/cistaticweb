                                                    ...
                                                    <?php endif ?>
                                                        <div class="row">
                                                                <?php if (is_null($process)): ?>
                                                                    ...
                                                                    <form method="post" action="<?php echo base_url('/Einsurance/malayan_insurance_test') ?>" class="transaction_form" id="frmMalayan">
                                                                    <div class="col-xs-6 col-md-5">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <input type="text" class="form-control inputNameValidator" name="inputFname" placeholder="FirstName" id="inputFnameEnsurance" required />
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <input type="text" class="form-control inputNameValidator" name="inputMname" id="inputMnameEnsurance" placeholder="MiddleName" required  />
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <input type="text" class="form-control inputNameValidator" name="inputLname" id="inputLnameEnsurance" disabled="" placeholder="LastName" required  />
                                                                        </div>
                                                                        <div class="form-group">
                                                                        ...
                                                                        <hr />
                                                                        <div class="form-group">
                                                                            <input type="text" class="form-control inputNameValidator" name="inputbFname" id="inputBFnameEnsurance" placeholder="Benificiary FirstName" disabled="" required />
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <input type="text" class="form-control inputNameValidator" name="inputbMname" id="inputBMnameEnsurance" placeholder="Benificiary MiddleName" disabled="" required  />
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <input type="text" class="form-control inputNameValidator" name="inputbLname" id="inputBLnameEnsurance" placeholder="Benificiary LastName" disabled="" required  />
                                                                        </div>
                                                                        <hr />
                                                                ...
                                                                <?php elseif ($process == 1): ?>
                                                                    ...
                                                                    <form method="post" action="<?php echo base_url('/Einsurance/malayan_insurance_test') ?>" id="frmMalayan">
                                                                        <div class="form-group">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <div class="input-group">
                                                                                <span class="input-group-addon" id="basic-addon1" style="padding-right: 5px;">Benificiary MiddleName: &nbsp;</span>
