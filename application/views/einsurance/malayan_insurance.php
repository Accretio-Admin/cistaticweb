...
<!--                                                    <div class="alert alert-success"><b><?php echo $result['M'].' TRANSACTION NO: <a href="'.$result['RL'].'" target="_blank"/></a>'.$result['TN'] ?></b></div> -->
                                                    <div class="alert alert-success"><b><?php echo $result['M'] ?><a href="<?php echo $result['RL'] ?>" target="_blank"> TRANSACTION NO: <?php echo $result['TN'];?></b></a></div>
                                                    <?php endif ?>
                                                        <div class="row">
                                                                 <?php if (is_null($process)): ?>

                                                                    <form method="post" action="<?php echo base_url('/Einsurance/malayan_insurance') ?>" class="transaction_form" id="frmMalayan">
                                                                    <div class="col-xs-6 col-md-5">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <input type="text" class="form-control inputLatinNameValidator" name="inputFname" placeholder="FirstName" id="inputFnameEnsurance" required />
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <input type="text" class="form-control inputLatinNameValidator" name="inputMname" id="inputMnameEnsurance" placeholder="MiddleName" required  />
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <input type="text" class="form-control inputLatinNameValidator" name="inputLname" id="inputLnameEnsurance" disabled="" placeholder="LastName" required  />
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <input type="text" class="form-control" id="datetimepicker" name="inputBdate" placeholder="Insured Birthdate" disabled="" required readonly />
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <input type="text" class="form-control" name="inputOccup" id="inputOccup" placeholder="Insured Occupation" disabled="" required  />
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <input type="email" class="form-control" name="inputEmail" id="inputEmail" placeholder="Insured Email Address" disabled=""/>
                                                                        </div>
                                                                        <hr />
                                                                        <div class="form-group">
                                                                            <input type="text" class="form-control inputLatinNameValidator" name="inputbFname" id="inputBFnameEnsurance" placeholder="Beneficiary FirstName" disabled="" required />
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <input type="text" class="form-control inputLatinNameValidator" name="inputbMname" id="inputBMnameEnsurance" placeholder="Beneficiary MiddleName" disabled="" required  />
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <input type="text" class="form-control inputLatinNameValidator" name="inputbLname" id="inputBLnameEnsurance" placeholder="Beneficiary LastName" disabled="" required  />
                                                                        </div>
                                                                        <hr />
                                                                        <div class="form-group text-right">
                                                                            <button type="button" class="btn btn-primary" id="btnContinueEnsurance" disabled="">Continue <span class="glyphicon glyphicon-share-alt" aria-hidden="true"></span></button>
                                                                        </div>
                                                                        ...
                                                                        <div class="modal-dialog">
                                                                          ...
                                                                          <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-footer">
                                                                              ...
                                                                              <button type="submit" class="btn btn-primary" name="btn_submit_malayan">Proceed</button>
                                                                            </div>
                                                                          </div>
                                                                ...
                                                                <?php elseif ($process == 1): ?>
                                                                    ...
                                                                    <form method="post" action="<?php echo base_url('/Einsurance/malayan_insurance') ?>" id="frmMalayan">
                                                                        <div class="form-group">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <div class="input-group">
                                                                                <span class="input-group-addon" id="basic-addon1" style="padding-right: 76px;">MiddleName: &nbsp;</span>
                                                                        ...
                                                                        <div class="form-group">
                                                                            <div class="input-group">
                                                                                <span class="input-group-addon" id="basic-addon1" style="padding-right: 19px;">Beneficiary FirstName: &nbsp;</span>
                                                                                <input type="text" class="form-control" name="inputbFname" value="<?php echo $info['bfname'] ?>" readonly />
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <div class="input-group">
                                                                                <span class="input-group-addon" id="basic-addon1" style="padding-right: 5px;">Beneficiary MiddleName: &nbsp;</span>
                                                                                <input type="text" class="form-control" name="inputbMname" value="<?php echo $info['bmname'] ?>" readonly  />
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <div class="input-group">
                                                                                <span class="input-group-addon" id="basic-addon1" style="padding-right: 20px;">Beneficiary LastName: &nbsp;</span>
                                                                ...
                                                                <?php if (is_null($process)): ?>
                                                                <div class="col-xs-6 col-md-7" id="malayanNote" style="display: none;">
                                                                <?php elseif ($process == 1): ?>
                                                                <div class="col-xs-6 col-md-5" >
                                                                <?php endif ?>
                                                                    <div class="form-group">
                                                                        ...
                                                                        <table class='table table-stripped'>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                <td>Accident Death, Dismemberment &/or Disablement</td>
                                                                                ...
                                                                                if($policy['PRE'] !='')
                                                                                {
                                                                                    ...
                                                                                    // if($("#selInsurance option:selected").val() == 1){
                                                                                    //     echo "80.00";
                                                                                    // }else if($("#selInsurance option:selected").val() == 2){
                                                                                    //     echo "55.00";
                                                                                    // }else if($("#selInsurance option:selected").val() == 3){
                                                                                    //     echo "45.00";
                                                                                    // }else if($("#selInsurance option:selected").val() == 4){
                                                                                    //     echo "50.00";
                                                                                    // }
                                                                                    echo "<span id='getPre'></span>";
                                                                                }
                                                                                ?></td>
                                                                                </tr>
