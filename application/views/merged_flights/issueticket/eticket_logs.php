                              ...
                              ?>
                                   <tr class="trPNR">
                                    ...
                                    <?php }
                                        ...
                                        <td>
                                          <a onclick="return confirm('This flight is Fare Adjustment Confirmation could not generate a report. Still on process. Please wait...','Domestic Ticketing Transactions')" class="btn btn-info" id="aPNR" data-toggle="tooltip" title="This flight is <?php echo $t['BS'] ?> could not generate a report."><?php echo 'Verify Status' ?></a> 
                                    ...
                                    <?php 
                                       ...
                                       if ($t['BS'] == "To Deliver"): ?>
                                        ...
                                        <?php else:?>
<!--                                             <td><a onclick="return confirm('Check Status?','Domestic Ticketing Transactions')" href="<?php echo BASE_URL() ?>Merged_ticketing_flights/eticketing/<?php echo $t['tn'] ?>" class="btn btn-primary"  id="aPNR" data-toggle="tooltip" title="Click here to check status"><?php echo 'Check Status' ?></a></td> -->
                                          <?php if ($t['provider']=='ABACUS') { ?>
                                            <td><a onclick="return confirm('This flight is <?php echo $t['BS'] ? $t['BS'] : "POSTED" ?> could not generate a report. Please create a ticket at https://csr.gomigu.com/login to verify your transactions.','Domestic Ticketing Transactions')" class="btn btn-info" id="aPNR" data-toggle="tooltip" title="Could not generate a report or create a ticket at https://csr.gomigu.com/login."><?php echo 'Verify Status' ?></a></td>
                                          
                                          <?php } else if ($t['provider']=='BYAHEKO' || $t['provider']=='byaheko') { ?>  
                                            <td><a onclick="return confirm('Check Status?','Domestic Ticketing Transactions')" href="<?php echo BASE_URL() ?>Merged_ticketing_flights/eticketing/2/<?php echo $t['tn'] ?>" class="btn btn-primary"  id="aPNR" data-toggle="tooltip" title="Click here to check status"><?php echo 'Check Status' ?></a></td>
                                          
                                          <?php } else { ?> 
                                            <td><a onclick="return confirm('Check Status?','Domestic Ticketing Transactions')" href="<?php echo BASE_URL() ?>Merged_ticketing_flights/eticketing/1/<?php echo $t['tn'] ?>" class="btn btn-primary"  id="aPNR" data-toggle="tooltip" title="Click here to check status"><?php echo 'Check Status' ?></a></td>
                                          <?php } ?>
...
<div id="myModal1" class="modal fade" role="dialog">
  <div class="modal-dialog">
    <form action="<?php echo BASE_URL() ?>Merged_ticketing_flights/eticketing" method="post" class="loading modal_loading" id="frmEticketsCon">
      <!-- Modal content-->
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">DOMESTIC BOOKING STATUS CONFIRMATION</h4>
        </div>
