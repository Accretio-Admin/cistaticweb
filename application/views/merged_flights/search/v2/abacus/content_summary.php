...
<!--                                <td><?php /*echo ($val = $p['Fare']['Code']=='PHP')? '₱ ': $val; */?></td>
                ...
                <table class="table" style="margin-top:10px;margin-bottom: 0px;">
                    ...
                    <tr>
                        <td class="text-right" colspan="9">
                            <button class="btn btn-primary" data-toggle="modal" data-target="#modal_proceed">Payment thru Ecash</button>
                            <button class="btn btn-success" data-toggle="modal" data-target="#modal_proceed_cc">Payment thru Credit Card</button>
    ...
    <div class="modal fade" id="modal_proceed_cc" role="dialog">
        <div class="modal-dialog modal-md">
            ...
            <form method="post" class="myform" action="#">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            ?>
                                ...
                                <?php 
                                    $new_price = $bag_price + $res_pricing['TotalFee']; 
                                    $final_fee = 0;
                                ?>

                                <?php if($totalfee >= $new_price) { ?>
                                    <?php $final_fee = $totalfee;?>
                                <?php } else { ?>
                                    <?php $final_fee = $new_price;?>
                                <?php } ?>
                           

                        <div class="form-group">
                            <div class="alert alert-danger alert-creditcard-validation" style="display:none; word-wrap:break-word;"></div>
                             <input type="text" class="form-control inputAmount" name="inputCCTOAmount" id="inputCCTOAmount" value="<?php echo $final_fee; ?>" placeholder="Enter desired amount" required readonly/>
                          </div>
                         <!-- <div class="form-group">
                          ...
                          <div class="form-group">
                           <!-- <select class="form-control" name="inputCCTOpaymenttype" id="inputCCTOpaymenttype" required readonly>
                                <option value="" disabled>Select payment type</option>
                                <option value="1" selected>CREDITCARD</option>
                            </select> -->
                            <input type="text" class="form-control inputCCTOpaymenttype" name="inputCCTOpaymenttype" id="inputCCTOpaymenttype" value="CREDITCARD" required readonly/>
                          </div>


                        <div class="form-group">
                            <i><font color='red'>Note:</font></i>
                            Credit card payments will be charged with an Web Admin Fee of 5.5% on total price (Php <?php echo number_format($final_fee,2);?>)<br>
                            Total Amount Due: <font color='red'><u><b>Php <?php echo number_format($final_fee + ($final_fee * 0.055),2);?></b></font></u><br><br>
                            <!-- <i><font color='red'>Disclaimer:</font></i><br>Upon clicking submit, you agree to the following:<ul><li>I certify that as the regcode owner, the credit/debit card to be used for this payment method is under my name.</li><li>I agree that this shall not be used in a manner that resembles a cash advance, remittance encashment or any other unauthorized or fraudulent mean.</li></ul> -->
                        </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        <!-- <button type="submit" class="btn btn-primary" name="btn_proceed" data-toggle="modal" data-target="#modal_proceed">Proceed</button> -->
                        <button type="submit" class="btn btn-primary" name="btn_proceed_cc">Proceed Payment thru Credit Card</button>
                    </div>
                </div>
            </form>
        </div>
