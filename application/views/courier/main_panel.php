          ...
          <?php if($response1['S'] == 1): ?>
            ...
            <div class="col-md-12">
              ...
              <div class="mt-1 col-md-4 rounded-corner" id="transactionDetails">
                <h2><b><?php if($status == "APPROVED"){ echo "TRANSACTION HAS BEEN "."<span style='color:green'>$status</span>";}elseif($status == "DENIED"){echo "TRANSACTION HAS BEEN "."<span style='color:red'>$status</span>";}elseif($status == "PENDING"){echo "TRANSACTION "."<span style='color:blue'>$status</span>";} ?></b></h2>
                ...
                <div class="form-group" id="receipt">
                  <div class="rounded-corner mb-1">
                    ...
                    <div class="receipt-deets">From: <span><?php echo $from ?></span></div>
                    <div class="receipt-deets">To: <span><?php echo $to ?></span></div>
                  </div>
                </div>
              </div>
              <div class="col-md-4"></div>
