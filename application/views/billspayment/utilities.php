...
<SCRIPT language=Javascript>
       ...
       function nameValidator() {
        var name = $('#datatype25 #inputSubscriberName').val();
     
        if (name.trim() == '') {
         alert("Please Enter Account Name..");
         $('#datatype25 #inputSubscriberName').val('');
          return false;
         } 
      }

      function accountNumberValidator(){
        var acctnumber = $('#datatype25 #inputAccountNumber').val();
        var acctstring = acctnumber.slice(0, 10);
        var regex = /^\d{3}-\d{2}-\d{3}$/im;
          if(acctstring.match(regex)){
            return true;
          }
          else {
            alert("Invalid Account Number");
            $('#datatype25 #inputAccountNumber').val('');
            return false;
          }
                ...
                <div class="utilities3" style="display: none;">
                    <form name="frmUtilitiesLoading" action="<?php echo BASE_URL() ?>Bills_payment/utilities" method="post" id="frmUtilitiesLoading"> 
                        ...
                        <div class="form-group">
                            ...
                            <input type="month"   class="form-control" name="inputBillingMonth" placeholder="BILLING MONTH - YYYYMM" />
                        </div>
                        <div class="form-group">
...
<!--                         <div class="form-group">
                ...
                <div class="utilities25" style="display: none;" id="datatype25" autocomplete="off"> 
...
<!--                         <div class="form-group">
                        ...
                        function myFunctiont() {
                          ...
                          // setTimeout(function(){ $("#tes").val(v); }, 1000);
                          // alert($(".cx").val());
                          
                          if($(".cx").val().includes("-") || $(".cx").val().includes("!") || $(".cx").val().includes("@") || $(".cx").val().includes("#") || $(".cx").val().includes("$")
                            || $(".cx").val().includes("%")
                            || $(".cx").val().includes("^")
                            || $(".cx").val().includes("&")
                            || $(".cx").val().includes("*")
                        ...
                        <div class="form-group" id="DynamicAcctName25">
                            <input type="text" class="form-control inputNameValidator inputSubscriberName forINECNAME ss" name="inputSubscriberName" id="inputSubscriberName" onchange = "nameValidator()" autocomplete = "off" oncopy = "return false" onpaste="return false" oncut="return false" placeholder="ACCOUNT NAME" required/>
                        </div>
                        ...
                        <script>
                          ...
                          $(function() {
                            $('body').on('keydown', '.forINECNAME', function(e) {
                          ...
                          $("#inputSubscriberName").keypress(function(event){
                          ...
                          // var regexs = /^[a-zA-Z0-9!@#\$%\^\&*\)\(+=._-]{6,}$/g;

                          // $("#inputSubscriberName").on("paste",function(e){
                          //    $(this).val(this.value.replace(/[^\d]/g,''))  
                          // })

                           $('#inputSubscriberName').on('paste', function (event) {
...
<!-- 
                        ...
                        <div class="form-group" id="divDynamicANTECOBiller25" style="display: none;">
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control dater inputBillerz" id="inputBillerz" name="inputBillingMonth" placeholder="BILL MONTH (mm/yyyy)" readonly required>
                            </div>
                        ...
                        <div class="form-group" id="DynamicDueDate25mdy" style="display: none;"> 
                          <input type="text" class="form-control inputDueDate" name="inputDueDate" id="todayAndUpdatepicker2"  placeholder="DUE DATE (mm/dd/yyyy)" oncopy = "return false" onpaste="return false" oncut="return false" readonly required/>
                        </div>
                        ...
                        <div class="form-group">
                            <input type="text" oninput="process(this)" class="form-control inputAmountmyModal25 forINECAMOUNT" name="inputAmount" id="inputAmount" placeholder="AMOUNT" onkeypress="return isNumberKey(event)" autocomplete='off' required />
                        </div>
                        ...
                        <div class="form-group text-right modal25">
                            <!-- <button type="submit" class="btn btn-primary" name="btnSubmit" value="1">SUBMIT</button> -->
                            <button type="button" class="btn btn-primary btn-lg btn_Modal25Submit" data-toggle="modal" data-target="#myModal25" id="btnSubmit">Submit</button>
                          ...
                          <div class="modal-dialog">
                                ...
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                          <span class="input-group-addon" id="basic-addon1" style="padding-right:25px;">Biller Name :</span>
...
<!--                    <div class="form-group">
                    ...
                    <form name="frmUtilitiesLoadingcagelco" action="<?php echo BASE_URL() ?>Bills_payment/utilities" method="post" id="cagelcoid"> 
                        <div class="form-group" id="divBiller23"></div>   
                         ...
                         <div class="form-group">
                              ...
                              <input type="hidden" class="form-control" value="1" name="inputType" id="inputAccountType" />
                        </div>
  ...
  <!-- CAGELCO XD -->
                        ...
                        <!-- divcheckStatus divcheckStatus divcheckStatus divcheckStatus divcheckStatus divcheckStatus divcheckStatus divcheckStatus -->
...
<div class="modal fade" id="cignalTV" data-backdrop="static" data-keyboard="false" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="row">
            <div class="col-md-12" style="text-align: center;">
            <br>
              Any authorized tampering and/or alteration of the Acknowledgement Receipt shall<br>
              render the same null and void. Furthermore, any tampering and/or alteration, shall be<br>
              subject to immediate deactivation of the bills pay service of the account.  
            </div>
          </div>
...
<script>
  $(document).ready(function(){
    ...
    $('.btn_Modal25Submit').click(function(e) {
      ...
      $('#dueDate').show();
        ...
        if (!duedate1){
          ...
          $('#myModal25 .idDueDate_1').html(duedate1);
        }
...
//$('#idAmount').remove(); //Amount//class-> idAmount
      ...
      if(billerNo == '749'){ 
      $("#dueDate").show();
      $("#idDueDate_1").html($("#inputBillerz").val());
      }
      ...
      if(billerNo == '749') {  
        let firstdigits = ["01", "02", "03", "04", "05", "06", "07", "08", "09", "10", "11", "12", "13", "14", "15"];
        if($("#inputAccountNumber").val() == ""){
          $(".btn_Modal25Submit").removeAttr("data-toggle");
          alert("Account number is empty.");
        }else if($("#inputAccountNumber").val().length != 12){
          $(".btn_Modal25Submit").removeAttr("data-toggle");
          alert("Account number should be 12 digits.");
        }else if($("#inputAccountNumber").val().substring(0,2) != $("#inputAccountNumber").val().substring(3,5)){
          $(".btn_Modal25Submit").removeAttr("data-toggle");
          alert("First 2-Digits should be equal to the 3rd and 4th digits");
        }else if(!firstdigits.includes($("#inputAccountNumber").val().substring(0,2))){
          $(".btn_Modal25Submit").removeAttr("data-toggle");
          alert("Invalid town code.");
        }else if($(".forINECNAME").val() == ""){
          $(".btn_Modal25Submit").removeAttr("data-toggle");
          alert("Account name is empty.");
        }else if($("#inputBillerz").val() == ""){
          $(".btn_Modal25Submit").removeAttr("data-toggle");
          alert("Bill month is empty.");
        }else if(!$(".forINECNAME").val().replace(/\s/g, '').length) {
          $(".btn_Modal25Submit").removeAttr("data-toggle");
          alert("Account name is empty.");
        }else if($("#inputBillerz").val() == ""){
          $(".btn_Modal25Submit").removeAttr("data-toggle");
          alert("Bill month is empty.");
        }else if($(".forINECMOBILE").val() == ""){
          $(".btn_Modal25Submit").removeAttr("data-toggle");
          alert("Mobile number is empty.");
        }else if($(".forINECMOBILE").val().length != 11){
          $(".btn_Modal25Submit").removeAttr("data-toggle");
          alert("Mobile number should be 11 digits.");
        }
        else if($(".forINECAMOUNT").val() == ""){
          $(".btn_Modal25Submit").removeAttr("data-toggle");
        ...
        // alert(!$(".forINECNAME").val().replace(/\s/g, '').length);
...
<script type="text/javascript">
  ...
  $('#btnRefresh').click(function(){
    ...
    $("#inputAccountNumberxx").attr("readonly", false);
    $("#inputAccountNumberxx").val("");
...
<script type="text/javascript">
  ...
  $('#btnCheckStatus').click(function(){
    if($('#inputGracePeriodsxx').val() === '' ){
      ...
      alert('Account Number should have 10 digits')
    ...
    CheckStatus();
        ...
        success: function (data) {
          ...
          if(res.S == 1){ //Please proceed with your transaction.
            ...
            if(res.TRACKNO){
              ...
              $("#inputAccountNumberxx").prop('readonly', false);
              $('#inputGracePeriodsxx').prop('readonly', true);
              $('#inputSubscriberNamexx').val(res.ACCTNAME)
              $('#inputMobilexx').val(res.MOBILE)
              $('#inputAmountxx').val(res.AMOUNT)
      ...
      $('#btnSubmitcagelco').click(function() {
        ...
        console.log("PREVATTACH",prevattach);
        ...
        // console.log(type);
        if(accountno != '' && billmonth != '' && accountname != '' && mobile != '' && amount != '' && discondate != '' && attachment != '' && type != '')
        {
...
<!-- <script>
                          $(".LARC").focusout(function(){
                          alert("test");

                            // var objRegex = /(^[0-9]+[-]*[0-9]+$)/;

                            // if(objRegex.test($(".LARC").val().substring(0,10)) == true)
                            // {
