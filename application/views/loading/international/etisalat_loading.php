            ...
            <!--=================| Error Message |==========================-->
              ...
              <?php if ($result['S'] == 1 && $result['TN'] != NULL): ?>
                  <div class="alert alert-success" style="width:auto;">&nbsp;&nbsp;<b>Transaction Successful!</b> Reference Number: <a href="<?php echo $result['URL']; ?>" target="_blank"><?php echo $result['TN']; ?></a><br>
                        ...
                        <?php if($_POST['inputEmail2']!='') echo' and to its secondary email address '.$_POST['inputEmail2'];?>
                  </div>
              <?php endif ?>
            <!--=================| Row Content |============================-->          
              <div class="row">
                  <div class='col-xs-12 col-md-12'>
                    <form name="paythemForm" action="<?php echo BASE_URL()?>international_loading/etisalat" method="post" id="frmetisalatloading">
                      <div class="form-group" ><?php //echo print_r($user)?>
                          ...
                          <?php 
                              foreach($BrandList as $rowBrand) {
                                  ...
                                  if( isset($_POST['selTelcoSGD']) && ($rowBrand['id'] == $_POST['selTelcoSGD']) ) {
                                    echo "<option data-id='".$rowBrand['telcoid']."' data-name='".$rowBrand['telconame']."' value='".$rowBrand['telcoid']."' selected>".$rowBrand['telconame']."</option>";
                                  } else {
                                    echo "<option data-id='".$rowBrand['telcoid']."' data-name='".$rowBrand['telconame']."' value='".$rowBrand['telcoid']."'>".$rowBrand['telconame']."</option>";
                                  }
                      ...
                      <br />
                      <div class="form-group">
                        <input type="email" class="form-control" name="inputEmail" value="<?php echo $_POST['inputEmail']; ?>" id="emailId" pattern="[^@]+@[^@]+\.[a-zA-Z]{2,6}" placeholder="Customer Email Address" required /><div id="emailMsg"></div>
                      </div>
                      <div class="form-group">
                        <input type="email" class="form-control" name="inputEmail2" value="<?php echo $_POST['inputEmail2']; ?>" id="emailId" pattern="[^@]+@[^@]+\.[a-zA-Z]{2,6}" placeholder="Customer Secondary Email Address (optional)"/>
                      </div>
                      <br/>
                      <div class="form-group">
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              ...
                              <div class="form-group">
                                <div class="input-group">
                                  <span class="input-group-addon" id="basic-addon1" style="padding-right:61px;">Secondary Email :</span>
                                  <span class="form-control" id="basic-addon2" style=""><label id="idEmail2" class="idEmail2"></label></span>
                                </div>
                              </div>
                              <div class="form-group">
                                <div class="input-group">
...
<script>
  ...
  $(document).ready(function(){
    ...
    $('.btn_ModalSubmit').click(function() {
      ...
      var email2 = $("input[name=inputEmail2]").val();
    ...
    $( "#selPlancodeSGDId" ).change(function() {
      ...
      var getPlancode =  Number($(this).find(':selected').data('plancode')).toFixed(2);
