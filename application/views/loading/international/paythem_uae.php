                ...
                <div class="row">
                    ...
                    <div class="col-xs-12  col-md-5">
                      ...
                      <?php if ($API['S'] == 1 && $API['TN'] != NULL): ?>
                          <div class="alert alert-success" style="width:auto;">&nbsp;&nbsp;<b>Transaction Successful!</b> Reference Number: <a href="<?php echo $API['RL']; ?>" target="_blank"><?php echo $API['TN']; ?></a><br>
                               &nbsp;&nbsp;<small>Click <a href="<?php echo $API['RL']; ?>" target="_blank">here</a> to download copy of the Acknowledgement Receipt.</small><br><br>
                               &nbsp;&nbsp;<b>Note:</b> The copy of the e-Voucher has been sent to client email address <?php echo $API['EA'] ?>
                          </div>
                      <?php endif ?>

                      <div class="row">
                          <div class='col-xs-12 col-md-12'>
                                <form name="paythemForm" action="<?php echo BASE_URL()?>international_loading_paythem?country=uae" method="post" id="frmetisalatloading">
                                            ...
                                            // print_r($ProductList);
                                                if($ProductList!=null){
                                                  foreach($ProductList as $rowProduct) {
                                                    // print_r($rowProduct);
                                                  // echo "<option id='".$rowProduct['OEM_BRAND_ID']."' value='".$rowProduct['OEM_PRODUCT_ID']."' hidden>".$rowProduct['OEM_PRODUCT_Name']." - ".$rowProduct['OEM_PRODUCT_SellPrice']."</option>";
                                      ...
                                      <div class="form-group">
                                         ...
                                         <input type="number" class="form-control" id="qtyId" name="inputQty" placeholder="Quantity" required/>
                                      </div> -->
                                      <br />
                                      <div class="form-group">
