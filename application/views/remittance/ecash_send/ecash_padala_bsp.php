...
<div class="mainpanel">
    ...
    <?php if ($details['process'] == 0) { ?>
        ...
        <?php if($transactStatus['S']==1 && $OTP['S']==1) : ?>
            ...
            <div id="divOTP">
                <form action="<?php echo BASE_URL() ?>ecash_send/ecashpadala" method="post" id="frmOTP" enctype="multipart/form-data">
                    ...
                    <div class="row" style="padding-top: 25px;">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-1">
                                <div class="form-group">
                                <a href="<?php echo BASE_URL() ?>ecash_send/ecashpadala" class="btn btn-default" id="returnOTP">APPROVE LATER</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row" id="divShowReceipt" hidden>
                <div class="col-md-2" style="margin-top: 25px;">
                    <div class="form-group">
                        <a href="<?php echo BASE_URL() ?>ecash_send/ecashpadala" class="btn btn-primary" id="returnSearchStep1"><span class="glyphicon glyphicon-arrow-left"></span> &nbsp;Return to Search</a> 
                    </div>
                </div>
                <div class="col-md-8">
                    <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <?php if($transactConfirmLow['S']==1): ?>
                                    <div class='col-md-12 text-center' style="padding-top: 20px;" id="divReceiptApprovedLow">
                                        <div class="form-group">
                                            <div>Reference No.    : <b><a href="https://mobilereports.globalpinoyremittance.com/portal/amla_transaction/<?php echo $transactBSPLow['TN'] ?>" id="receiptLink" target="_blank"><span id="receiptReferencenoLow"><?php echo $transactBSPLow['TN'] ?></span></a></b></div>
                                        </div> 
                                    </div>
                                <?php endif ?>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" name="inputRelation" id="inputRelation" placeholder="RELATION TO RECEIVER" onkeypress="return isLetterKey(event)" value="<?php echo $inputRelation ?>" required/>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" name="inputPurpose" id="inputPurpose" placeholder="PURPOSE OF TRANSACTION" onkeypress="return isLetterKey(event)" value="<?php echo $inputPurpose ?>" required/>
                            </div>  
                            <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="inputAmount" placeholder="Enter Amount" id="inputAmount" title="Input must be a number or decimal." autocomplete="off" oninput="validate(this)" onkeyup="amountValidate()" maxlength="8" required/>
                                <span style="color: red;" id="ammont_err">Minimum amount is P1.00</span>
                                <span style="color: red;" id="ammont_err2">Maximum amount is P50,000.00</span>
                            </div>  
                            <!-- <div class="form-group">
            ...
            <div class="row row-stat">
                <div class="col-md-12">
                        <div class="row" id="divSearchSender">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <?php if ($row['S']==1): ?>
                                                ...
                                                <?php endif ?>
                                                <form name="frmecashpadalabene" action="<?php echo BASE_URL() ?>ecash_send/ecashpadala" method="post" id="frmBSeachRemit" >
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <form action="<?php echo BASE_URL() ?>ecash_send/ecashpadala" method="post"  id="frmTransacBSP">
                    ...
                    <div id="senderFormData" class="col-md-12" hidden >
                        ...
                        <form action="<?php echo BASE_URL() ?>ecash_send/ecashpadala" method="post"  id="frmAddEcashPadalaBeneficiary">
                            <div class="col-md-1"></div>
                            <div class="col-md-10">
                                <div class='col-md-12 text-center'>
                                    <div class="form-group">
    ...
    <div class="modal fade" id="addModalSender" role="dialog" data-keyboard="false" data-backdrop="static">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <form action="<?php echo BASE_URL() ?>ecash_send/ecashpadala" method="post"  id="frmAddEcashPadalaSender" enctype="multipart/form-data">
    ...
    <div class="modal fade" id="remittanceSummaryModal" role="dialog" >
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form name="frmSummaryConfirmation" action="<?php echo BASE_URL() ?>ecash_send/ecashpadala" method="post" id="frmSummaryConfirmation" > 
            ...
            <input hidden name="service" id="hiddenService" value="ECASHPADALA"/>
  ...
  <script type="text/javascript">
    ...
    function fetchRate(){
        ...
        $.ajax({
            url         : '/Ecash_send/fetch_ecashpadala_rate',
            type        : 'POST',
            data        : formData,
            processData : false,
            contentType : false,
            success     : function (data) {
                ...
                if(jsonData.S == 1){
                    tCharge = parseFloat(jsonData.C).toFixed(2)
                        ...
                        if(jsonData.S == 1){
                            ...
                            $.ajax({
                                ...
                                success     : function (data) { 
                                    ...
                                    if(jsonData.S == 1){
                                        $.ajax({
                                            url         : '/Ecash_send/ecashpadalaTransacBSP',
                                            type        : 'POST',
                                            data        : formData3,
                                            processData : false,
                                            contentType : false,
