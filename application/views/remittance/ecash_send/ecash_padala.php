                ...
                <div class="col-md-6">
                   <form name="frmecashpadalasender" action="<?php echo BASE_URL() ?>ecash_send/ecashpadala" method="post" id="frmSSeachRemit" >
                      <table class="table table-stripped">
                            <tr>
                                <td>Sender Id</td>
                                <td> <input type="text"  class="col-md-12" name="sender_id" value="<?php echo $details['sender_id']?>" readonly> </td>
                            </tr>
                            <tr>
                                <td>Sender name</td>
                                <td> <input type="text" class="col-md-12" name="sender_name" value="<?php echo $details['sender_name']?>" readonly> </td>
                            </tr>
                            <tr>
                                <td>Sender Mobile</td>
                                <td> <input type="text" class="col-md-12" name="sender_mobile" value="<?php echo $details['mobile']?>" readonly> </td>
                            </tr>
                            <tr>
                                <td>beneficiary Id</td>
                                <td> <input type="text" class="col-md-12" name="bene_id" value="<?php echo $details['bene_id']?>" readonly> </td>
                            </tr>
                            <tr>
                                <td>Beneficiary name</td>
                                <td> <input type="text" class="col-md-12" name="bene_name" value="<?php echo $details['bene_name']?>" readonly> </td>
                            </tr>
                            <tr>
                                <td>Amount </td>
                                <td> <input type="text" class="col-md-12" name="amount" value="<?php echo $details['amount']?>" readonly> </td>
                            </tr>
                            <tr>
                                <td>Charge </td>
                                <td> <input type="text" class="col-md-12" name="charge" value="<?php echo $details['charge']?>" readonly> </td>
                            </tr>
                             <tr>
                                <td>Transaction password </td>
                                <td>  <input type="password" class="col-md-12" name="tpass" value="<?php echo $details['tpass']?>" required>  </td>
                            </tr>
                            <tr>
                                <td colspan="2" align="right"><button name="btnConfirm" type ="submit" class="btn btn-default">Submit</button></td>
                            </tr>
                      </table> 
