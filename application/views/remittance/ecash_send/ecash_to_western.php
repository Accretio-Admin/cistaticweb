        ...
        <div class="col-lg-12"> 
          <div class="row" style="margin-bottom: 30px;">
            <ul class="nav nav-tabs">
              <li class="active"><a href="<?php echo BASE_URL()?>ecash_send/ecashtowestern" style="color: #428bca;"><b>SENDING</b></a></li> 
              <li><a href="<?php echo BASE_URL()?>ecash_send/logs_ecashtowestern">PENDING</a></li>  
                    ...
                    <div class="col-md-6">
                      <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                              <form name="frmecashpadalasender" action="<?php echo BASE_URL() ?>ecash_send/ecashtowestern" method="post" id="frmSSeachRemit" >
                                <div class="row">
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <div class="form-group">
                            <form name="frmecashpadalabeneficiary" action="<?php echo BASE_URL() ?>ecash_send/ecashtowestern" method="post" id="frmBSeachRemit"  >
                                        <div class="row">
                                            <div class='col-xs-12 col-md-12'>
                                                <div class="row">
                                                   <div class="col-md-10">
                                  ...
                                  <table id="example"  class="table table-bordered" cellspacing="0" style="width:100%;">
                                            ...
                                            <tbody>
                                              ...
                                              <tr class="tr">
                                                  ...
                                                  <td><a id="aFindWestern" class="btn btn-danger" data-id="<?php echo $type['typeid'].'|'.'SEND'?>" href="#">Select</a></td>
              ...
              <form id="frmWesternSender">
                <div class="form-group"><h4>SENDER</h4></div>
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    <div class="row">
                      <div class="col-md-9" style="padding-right: 0px;">
                        <div class="input-group">
                          <span class="input-group-addon" id="basic-addon1" style="padding-right: -5px;">PRINCIPAL AMOUNT:</span>
                   ...
                   <div class="form-group">
                      <div class="input-group">
                        <span class="input-group-addon" id="basic-addon1" style="padding-right: 23px;">SERVICE CHARGE:</span>
                  ...
                  <div class="form-group">
                      <div class="input-group">
                        <span class="input-group-addon" id="basic-addon1" style="padding-right: 41px;">TOTAL AMOUNT:</span>
  ...
  <div class="modal fade" id="addModal" role="dialog" >
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form action="<?php echo BASE_URL() ?>ecash_send/ecashtowestern" method="post"  id="frmAddEcashPadala">
            <div class="modal-body">
              <div class="row">
                  <div class="col-md-12">
