...
<script>
    ...
    $(document).ready(function(){
        ...
        if($('#frmNewEcashPadalaSender').is(':visible')){
            ...
            setTimeout( function(){
                if($('#newidtypeDealer').length == 1){
                    waitingDialog.show('Please Wait...', {dialogSize: 'md', progressType: 'primary'});
                    fetch_IDs_dealer()     
                }
            }, 250 );
        ...
        if($('#serviceType').is(':visible')){
        waitingDialog.show('Loading available e-wallets, Please Wait...', {dialogSize: 'md', progressType: 'primary'});
            $.ajax({
                url         : '/Ecash_send/fetch_walletServices',
                type        : 'POST',
                processData : false,
                contentType : false,
                success     : function (data) {
                    var jsonData = JSON.parse(data);
                    //console.log("SHOW_WALLET_SERVICES",jsonData)
                    jsonData.M.forEach(function(i){
                        // console.log(i)
                        $('#serviceType').append($('<option>', {
                            id: i.rowid,
                            value: i.service_code,
                            text: i.service_code
                        }));
                        $('#'+i.rowid).attr('data-description', i.description)
                        $('#'+i.rowid).attr('data-firstfield', i.first_field)
                        $('#'+i.rowid).attr('data-secondfield', i.second_field)
                    })
                    waitingDialog.hide()
                }
            })
...
<div class="mainpanel">
    ...
    <?php if ($details['process'] == 0) { ?>
        ...
        <?php if($transactStatus['S']==1 && $OTP['S']==1) : ?>
            ...
            <div id="divOTP">
                <form action="<?php echo BASE_URL() ?>ecash_send/ecash_topup_wallet" method="post" id="frmOTP" enctype="multipart/form-data" novalidate>
                    ...
                    <div class="row" style="padding-top: 25px;">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-1">
                                <div class="form-group">
                                <a href="<?php echo BASE_URL() ?>ecash_send/ecash_topup_wallet" class="btn btn-default" id="returnOTP">APPROVE LATER</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row" id="divShowReceipt" hidden>
                <div class="col-md-2" style="margin-top: 25px;">
                    <div class="form-group">
                        <a href="<?php echo BASE_URL() ?>ecash_send/ecash_topup_wallet" class="btn btn-primary" id="returnSearchStep1"><span class="glyphicon glyphicon-arrow-left"></span> &nbsp;Return to Search</a> 
                    </div>
                </div>
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <div class="col-md-4" style="padding-top: 20px;">
                            <div class="form-group">
                                <div class="input-group">
                                    <span class="input-group-addon" id="basic-addon1">E-WALLET</span>
                            ...
                            <div class="form-group">
                                ...
                                <?php if($transactConfirmLow['S']==1): ?>
                                    <div class='col-md-12 text-center' style="padding-top: 20px;" id="divReceiptApprovedLow">
                                        <div class="form-group">
                                            <div>Reference No.    : <b><a href="https://mobilereports.globalpinoyremittance.com/portal/ecpay_fund_transfer/<?php echo $transactBSPLow['TN'] ?>" id="receiptLink" target="_blank"><span id="receiptReferencenoLow"><?php echo $transactBSPLow['TN'] ?></span></a></b></div>
                                        </div> 
                                ...
                                <div class="col-md-4" style="padding-top: 20px;">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon" id="basic-addon1">E-WALLET</span>
                                            <input type="text" class="form-control" name="receiptService" id="receiptService" value="<?php echo $low['servicetype'] ?>" disabled />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4" style="padding-top: 20px;">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon" id="basic-addon1">FIRST DETAIL</span>
                                            <input type="text" class="form-control" name="receiptFirstField" id="receiptFirstField" value="<?php echo $low['firstfield'] ?>" disabled />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4" style="padding-top: 20px;">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon" id="basic-addon1">SECOND DETAIL</span>
                                            <input type="text" class="form-control" name="receiptSecondField" id="receiptSecondField" value="<?php echo $low['secondfield'] ?>" disabled />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3" style="padding-top: 20px;">
                                ...
                                <div class="col-md-3" style="padding-top: 20px;">
                                   <div class="form-group">
                                       <div class="input-group">
                                           <span class="input-group-addon" id="basic-addon1">CHARGE</span>
                                           <input type="text" class="form-control" name="receiptAmount" id="receiptAmount" value="<?php echo $receiptCharge ?>" disabled />
                                      </div>
                                  </div>
                                </div>
        ...
        <?php elseif ($AddBene['S']==1 || $okTransac['S']==1 || $selectedID1 && $selectedID2 && $transactStatus['S']===0): ?>
            <?php if ($AddBene['S']==1): ?>
                <div class="alert alert-success"><b>SUCCESSFULLY ADDED BENEFICIARY!</b></div>
            <?php endif ?>
            ...
            <form action="<?php echo BASE_URL() ?>ecash_send/ecash_topup_wallet" method="post"  id="frmProceedEcashPadala" autocomplete="off">
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <b><h3 style="text-align: center">WALLET TOP-UP</h3></b>
                            </div>
                            <div class="form-group">
                            ...
                            <h4 style="text-align: left">Available E-wallet(s) :</h4>
                                <select class="form-control" style="text-align: center" name="serviceType" id="serviceType"> 
                                    <option value="" disabled selected>Choose E-wallet</option>
                                </select>
                            </div>
                            <div class='col-md-6'>
                            <h4 style="text-align: left">Wallet Description :</h4>
                                <label type="text" class="form-control" name="lblServiceTypeDesc" id="lblServiceTypeDesc" placeholder="Wallet Description"></label>
                                <input type="hidden" class="form-control" name="serviceTypeDesc" id="serviceTypeDesc"/>
                            </div>
                            </div>
                            ...
                            <div class="form-group">
                            <div class='col-md-6'>
                                <h4 style="text-align: left">Relation to Receiver :</h4>
                                <input type="text" class="form-control" id="inputRelation" name="inputRelation" placeholder="Relation to Receiver" maxlength="45" onpaste="return /[a-zA-Z ]/i.test(event.key)" onkeypress="return /[a-zA-Z ]/i.test(event.key)" required/>
                            </div>
                            <div class='col-md-6'>
                                <h4 style="text-align: left">Purpose of Transaction :</h4>
                                <input type="text" class="form-control" id="inputPurpose" name="inputPurpose" placeholder="Purpose of Transaction" maxlength="45" onpaste="return /[a-zA-Z ]/i.test(event.key)" onkeypress="return /[a-zA-Z ]/i.test(event.key)" required/>
                            </div>  
                            </div> 

                            <!-- first field, second field -->
                            <div class="form-group" id="serviceVariation1">
                                <div class='col-md-6' >
                                <h4 style="text-align: left">Primary Transaction Detail :</h4>
                                    <input type="text" class="form-control" name="firstField" id="firstField" placeholder="" disabled required/>
                                    <span style="color: red;" id="transac_errMobileNum1">Incorrect number format. </span> 
                                </div>
                                <div class='col-md-6'>
                                <h4 style="text-align: left">Secondary Transaction Detail :</h4>
                                    <input type="text" class="form-control" name="secondField" id="secondField" placeholder="" onkeydown="this.value = this.value.replace(/[^a-zA-Z0-9]/g, '')" disabled required/>
                                    <span style="color: red;" id="transac_errMobileNum2">Incorrect number format. </span>
                                </div>
                            </div>

                            <div class="form-group">
                                <div class='col-md-6'>
                                <h4 style="text-align: left">Currency :</h4>
                                    <select class="form-control" name="selCurrency" id="selCurrency" disabled>
                                        <option value="PHP" selected>Philippine Peso (PHP)</option>
                                    </select>
                                </div>
                                <input type="hidden" class="form-control" id="inputCurrency" name="inputCurrency" placeholder="Currency" value="PHP"/>
                                <div class='col-md-6'>
                                <h4 style="text-align: left">Top-up Amount :</h4>
                                    <input type="text" class="form-control" name="inputAmount" placeholder="Enter Amount" id="inputAmount" title="Input must be a number or decimal." autocomplete="off" oninput="validate(this)" onkeyup="amountValidate()" maxlength="8" required/>   
                                        <span style="color: red;" id="amount_err1">Minimum top-up should be ₱100.00</span>
                                        <span style="color: red;" id="amount_err2">Maximum top-up should be ₱50,000.00</span>                               
                                </div>
                            </div>
                    ...
                    <div class="col-md-12" style="padding-bottom: 30px; text-align: center">
                        <button type="button" class="btn btn-primary" id="btnModalTransaction" name="btnModalTransaction" disabled>SUBMIT</button>
                    </div>
                    </div>
            </form>
        <?php else: ?>
       <?php if ($row['S']===0): ?>
        ...
        <?php if($DEALER['M'] == "NEW"): ?>
            <div class="container flex-center col noRecord" id="err">
                <h1 class="mt-3" style="font-weight:bold">No Record(s) Found</h1>
            ...
            <div class="row row-stat">
                <div class="col-md-12">
                    <div class="row" id="divSearchSender">
                        <div class="col-md-6">
                            <div class="row">
                                ...
                                <?php else: ?>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <form name="frmecashpadalasender" action="<?php echo BASE_URL() ?>ecash_send/ecash_topup_wallet" method="post" id="frmSSeachRemit" >
                                                <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <?php if ($row['S']==1): ?>
                                            ...
                                            <?php endif ?>
                                            <form name="frmecashpadalabene" action="<?php echo BASE_URL() ?>ecash_send/ecash_topup_wallet" method="post" id="frmBSeachRemit" >
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <form action="<?php echo BASE_URL() ?>ecash_send/ecash_topup_wallet" method="post"  id="frmTransacBSP">
                    ...
                    <div id="senderFormData" class="col-md-12" hidden >
                        ...
                        <form action="<?php echo BASE_URL() ?>ecash_send/ecash_topup_wallet" method="post"  id="frmAddEcashPadalaBeneficiary">
                            <div class="col-md-1"></div>
                            <div class="col-md-10">
                                <div class='col-md-12 text-center'>
                                    <div class="form-group">
                                ...
                                <div id="step1">
                                    ...
                                    <div class='col-md-6'>
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="inputFnameBene" id="inputFnameBene" placeholder="FIRSTNAME" oninput="this.value = this.value.toUpperCase()" onkeypress="return isLetterKey(event)" onkeyup="this.value = this.value.replace(/[^a-zA-Z ]/g, '')" required/>
                                        </div> 
                                    </div>
                                    <div class='col-md-6'>
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="inputMnameBene" id="inputMnameBene" placeholder="MIDDLENAME" oninput="this.value = this.value.toUpperCase()" onkeypress="return isLetterKey(event)" onkeyup="this.value = this.value.replace(/[^a-zA-Z ]/g, '')" />
                                        </div> 
                                    </div>
                                    <div class='col-md-8'>
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="inputLnameBene" id="inputLnameBene"  placeholder="LASTNAME" oninput="this.value = this.value.toUpperCase()" onkeypress="return isLetterKey(event)" onkeyup="this.value = this.value.replace(/[^a-zA-Z ]/g, '')" required/>
                                        </div> 
                                    </div>
                                    <div class='col-md-4'>
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="inpuSuffixBene" id="inpuSuffixBene"  placeholder="SUFFIX" oninput="this.value = this.value.toUpperCase()" onkeyup="this.value = this.value.replace(/[^a-zA-Z. ]/g, '')"/>
                                        </div> 
                                    </div>
                                    ...
                                    <div class='col-md-8' style="padding-top:10px;">
                                        <div class="form-group">
                                            ...
                                            <span style="color: red;" id="amount_errEmailSender">Incorrect email format. </span>
                                        </div>
                                    </div>
                                    <div class='col-md-4' style="padding-top:10px;">
                                        <div class="form-group" >
                                            <input type="text" class="form-control" name="inputMobileBene" id="inputMobileBene" placeholder="MOBILE NUMBER" onkeypress="return isNumberKey(event)" onkeyup="this.value = this.value.replace(/[^0-9]/g, '')" maxlength="11" required/>
                                            <span style="color: red;" id="amount_errMobileNum">Incorrect number format. </span>  
                                        </div> 
                                    </div>
    ...
    <div class="modal fade" id="addModalSender" role="dialog" data-keyboard="false" data-backdrop="static">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <form action="<?php echo BASE_URL() ?>ecash_send/ecash_topup_wallet" method="post"  id="frmAddEcashPadalaSender" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div id="step1">
                                    <div class='col-md-6'>
                                        <div class="form-group">
                                         <input type="text" class="form-control" name="inputFname" id="inputFname" placeholder="FIRSTNAME" oninput="this.value = this.value.toUpperCase()" onkeypress="return /[a-zA-Z ]/i.test(event.key)" required/>
                                        </div> 
                                    </div>
                                    <div class='col-md-6'>
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="inputMname" id="inputMname" placeholder="MIDDLENAME" oninput="this.value = this.value.toUpperCase()" onkeypress="return /[a-zA-Z ]/i.test(event.key)" />
                                        </div> 
                                    </div>
                                    <div class='col-md-8'>
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="inputLname" id="inputLname"  placeholder="LASTNAME" oninput="this.value = this.value.toUpperCase()" onkeypress="return /[a-zA-Z ]/i.test(event.key)" required/>
                                        </div> 
                                    </div>
                                    <div class='col-md-4'>
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="inpuSuffix" id="inpuSuffix"  placeholder="SUFFIX" oninput="this.value = this.value.toUpperCase()" onkeypress="return /[a-zA-Z. ]/i.test(event.key)" />
                                        </div> 
                                    </div>
                                    ...
                                    <div class='col-md-4' style="padding-top:10px;">
                                        <div class="form-group" >
                                            ...
                                            <span style="color: red;" id="amount_errMobileNum1">Incorrect number format. </span>  
                                        </div> 
                                    </div>
                                    ...
                                    <div class='col-md-4'>
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="inputOccupation" id="inputOccupation"  placeholder="OCCUPATION" oninput="this.value = this.value.toUpperCase()" onkeypress="return isLetterKey(event)" required/>                                        </div>
                                    </div>
                                    <div class='col-md-4'>
                                        <div class="form-group">
                                    ...
                                    <div class='col-md-4'>
                                        <div class="form-group" >
                                            <input type="text" class="form-control" name="inputNationality" id="inputNationality" placeholder="NATIONALITY" oninput="this.value = this.value.toUpperCase()" onkeypress="return isLetterKey(event)" required/>
                                        </div> 
                                    </div>
                                </div>
                                <div id="step2">
    ...
    <div class="modal fade" id="remittanceSummaryModal" role="dialog" >
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form name="frmSummaryConfirmation" action="<?php echo BASE_URL() ?>ecash_send/ecash_topup_wallet" method="post" id="frmSummaryConfirmation" > 
            ...
            <input hidden name="inputService" id="hiddenService" value="ECCASH"/>
            <input hidden name="serviceType" id="hiddenServiceType"/>
            <input hidden name="firstField" id="hiddenFirstField"/>
            <input hidden name="secondField" id="hiddenSecondField"/>
            ...
            <div class="modal-body">
              ...
              <div class="row">
                <div class='col-xs-12 col-md-12'>
                  <div class="input-group">
                    <span class="input-group-addon" id="basic-addon1" style="text-align: left; padding-right: 121px;">SENDER ID:</span>
              ...
              <div class="row">
                <div class='col-xs-12 col-md-12'>
                  <div class="input-group">
                    <span class="input-group-addon" id="basic-addon1" style="text-align: left; padding-right: 60px;">BENEFICIARY NAME:</span>
              ...
              <div class="row">
                <div class='col-xs-12 col-md-12'>
                  <div class="input-group">
                    <span class="input-group-addon" id="basic-addon1" style="text-align: left; padding-right: 30px;">RELATION TO RECEIVER:</span>
              ...
              <div class="row">
                <div class='col-xs-12 col-md-12'>
                  <div class="input-group">
                    <span class="input-group-addon" id="basic-addon1" style="text-align: left; padding-right: 33px;">TRANSACTION DETAIL 1:</span>
                    <input type="text" class="form-control" name="ifield1" id="ifield1" readonly="">
                  </div>
                </div>
              </div>
              <div class="row">
                <div class='col-xs-12 col-md-12'>
                  <div class="input-group">
                  <span class="input-group-addon" id="basic-addon1" style="text-align: left; padding-right: 33px;">TRANSACTION DETAIL 2:</span>
                    <input type="text" class="form-control" name="ifield2" id="ifield2" readonly="">
                  </div>
                </div>
              </div>
              <div class="row">
                <div class='col-xs-12 col-md-12'>
                  <div class="input-group">
                    <span class="input-group-addon" id="basic-addon1" style="text-align: left; padding-right: 129px;">PURPOSE:</span>
              ...
              <div class="row">
                <div class='col-xs-12 col-md-12'>
                  <div class="input-group">
                    <span class="input-group-addon" id="basic-addon1" style="text-align: left; padding-right: 119px;">CURRENCY:</span>
              ...
              <div class="row">
                <div class='col-xs-12 col-md-12'>
                  <div class="input-group">
                    <span class="input-group-addon" id="basic-addon1" style="text-align: left; padding-right: 63px;">PRINCIPAL AMOUNT:</span>
    ...
    <?php if ($details['process'] == 1) {?>
          <div class="row">
              <div class="col-md-12"><h2>Are you sure you want to confirm?</h3></div>
                   <form name="frmecashpadalasender" action="<?php echo BASE_URL() ?>ecash_send/ecash_topup_wallet" method="post" id="frmSSeachRemit" novalidate>
                        <div class="form-group">
                            <h4 id="headerResult">Selected Sender Details :</h4>
                            <table id="tblSelectedSender"  class="table" cellspacing="0" style="width:100%;">
                                <tbody>
  ...
  <script type="text/javascript">
    ...
    $('#transac_errMobileNum1').hide();
    $('#transac_errMobileNum2').hide();
    ...
    $('#viewModalSender').click(function(){ ///test
    ...
    var tRelation, tPurpose, tCurrency, tAmount, tService, tFirstField, tSecondField, tCharge,
        idS, fullS, bdateS,
        idR, fullR, bdateR;
    ...
    $('#btnModalTransaction').click(function(){
        ...
        tService     = $('#frmProceedEcashPadala #serviceType').val();
        tFirstField  = $('#frmProceedEcashPadala #firstField').val();
        tSecondField = $('#frmProceedEcashPadala #secondField').val();
        ...
        if(tRelation && tPurpose && tCurrency && tAmount && tService && tFirstField && tSecondField){
            waitingDialog.show('Please Wait.', {dialogSize: 'sm', progressType: 'primary'});
            $('#tpass').val('');
            fetchRate();
        }else{
    ...
    function fetchRate(){
        ...
        formData.append('service', tService)

        $.ajax({
            url         : '/Ecash_send/fetch_ecash_wallettopup_rate',
            type        : 'POST',
            data        : formData,
            processData : false,
            contentType : false,
            success     : function (data) {
                ...
                if(jsonData.S == 1){
                    tCharge = (parseFloat(tAmount) * 0.01).toFixed(2);
                    ...
                    $('#ifield1').val(tFirstField);
                    $('#ifield2').val(tSecondField);
                    ...
                    $('#hiddenServiceType').val(tService);
                    $('#hiddenFirstField').val(tFirstField);
                    $('#hiddenSecondField').val(tSecondField);
                    $('#icharge').val(tCharge);
                    $('#hiddenInputCharge').val(tCharge);
                        ...
                        if(jsonData.S == 1){
                            ...
                            $.ajax({
                                ...
                                success     : function (data) { 
                                    ...
                                    if(jsonData.S == 1){
                                        $.ajax({
                                            url         : '/ecash_send/ecashwallettopupTransacBSP',
                                            type        : 'POST',
                                            data        : formData3,
                                            processData : false,
                                            contentType : false,
...
<script>
    ...
    $('#tpass').keyup(function(){
        if($('#tpass').val() == ''){
            $('#btnSubmitBSP').prop('disabled', true)
        }
        else{
            $('#btnSubmitBSP').prop('disabled', false)
        }
      })
...
<script>
    var errChecker1, errChecker2, mobileChecker1, mobileChecker2;
    function inputNum(){
    var numTest = /^[0][9]\d{9}$/gm;
    var numVal = $(this).val()
        ...
        if(numTest.test(numVal)){
            ...
            if(errChecker1 == 1){
                $('#transac_errMobileNum1').show();
            }
            if(errChecker2 == 1){
                $('#transac_errMobileNum2').show();
            }
            // console.log(numVal)
    ...
    //input data for every service type dropdown
    $('#serviceType').on('change', function(){
        var firstField  = $(this).children(":selected").data('firstfield')
        var secondField = $(this).children(":selected").data('secondfield')
        var desc = $(this).children(":selected").data('description')

        $('#firstField').prop('disabled', false)
        $('#secondField').prop('disabled', false)

        $('#lblServiceTypeDesc').text(desc)
        $('#serviceTypeDesc').val(desc)
        $('#firstField').attr('placeholder', firstField)
        $('#secondField').attr('placeholder', secondField)
        $('#firstField').val('')
        $('#secondField').val('')
        $('#inputAmount').val('')
        ...
        if($(this).children(":selected").data('description') == "GLOBE GCASH"){
            $('#transac_errMobileNum2').hide();
            $('#firstField').attr({onkeypress:"return isNumberKey(event)", maxlength:"11"})
            $('#firstField').keyup(inputNum)
            $('#secondField').attr({onkeypress:"return isLetterKey(event)", maxlength:"45"}).removeAttr("keyup")
            errChecker1 = 1;
            errChecker2 = 0;
        } else if($(this).children(":selected").data('description') == "PAYMAYA"){
            $('#transac_errMobileNum1').hide();
            $('#firstField').attr({maxlength:"7"}).removeAttr("keyup").removeAttr("onkeypress")
            $('#secondField').attr({onkeypress:"return isNumberKey(event)", maxlength:"11"})
            $('#secondField').keyup(inputNum)
            errChecker1 = 0;
            errChecker2 = 1;
        }
    ...
    function amountValidate(){
        if($('#inputAmount').val() < 100 ){
            ...
            if((mobileChecker1 == 1)&&(mobileChecker2 == 1)){
                $('#btnModalTransaction').prop('disabled', false)
            }
            $('#amount_err1').hide()
            $('#amount_err2').hide()
