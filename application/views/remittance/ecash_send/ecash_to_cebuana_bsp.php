...
<div class="mainpanel">
    ...
    <?php if ($details['process'] == 0) { ?>
        ...
        <?php if($transactStatus['S']==1 && $OTP['S']==1) : ?>
            ...
            <div id="divOTP">
                <form action="<?php echo BASE_URL() ?>ecash_send/ecashtocebuana" method="post" id="frmOTP" enctype="multipart/form-data">
                    ...
                    <div class="row" style="padding-top: 25px;">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-1">
                                <div class="form-group">
                                <a href="<?php echo BASE_URL() ?>ecash_send/ecashtocebuana" class="btn btn-default" id="returnOTP">APPROVE LATER</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row" id="divShowReceipt" hidden>
                <div class="col-md-2" style="margin-top: 25px;">
                    <div class="form-group">
                        <a href="<?php echo BASE_URL() ?>ecash_send/ecashtocebuana" class="btn btn-primary" id="returnSearchStep1"><span class="glyphicon glyphicon-arrow-left"></span> &nbsp;Return to Search</a> 
                    </div>
                </div>
                <div class="col-md-8">
                    <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <?php if($transactConfirmLow['S']==1): ?>
                                    <div class='col-md-12 text-center' style="padding-top: 20px;" id="divReceiptApprovedLow">
                                        <div class="form-group">
                                            <div>Reference No.    : <b><a href="https://mobilereports.globalpinoyremittance.com/portal/cebuana_remittance/domestic_sending_receipt/<?php echo $transactBSPLow['TN'] ?>" id="receiptLink" target="_blank"><span id="receiptReferencenoLow"><?php echo $transactBSPLow['TN'] ?></span></a></b></div>
                                        </div> 
                                    </div>
                                <?php endif ?>
        ...
        <?php elseif ($AddBene['S']==1 || $okTransac['S']==1 || $selectedID1 && $selectedID2 && $transactStatus['S']===0): ?>
                    ...
                    <table id="tblSelectedSender"  class="table" cellspacing="0" style="width:100%;">
                        ...
                        <?php  foreach ($selectedID1['result'] as $i): ?>
                            ...
                            <tr class="tr">
                                ...
                                <td hidden id="tdIdS"><?php echo $i['customer_id']; ?></td>
                                <td id="tdClIdS"><?php if($i['cl_id']){echo $i['cl_id'];}else{ echo "NO CL ID";}  ?></td>
                                <td><?php if($i['cl_no']){echo $i['cl_no'];}else{ echo "NO CL NUMBER";} ?></td>
                    ...
                    <table id="tblSelectedSender"  class="table" cellspacing="0" style="width:100%;">
                        ...
                        <?php  foreach ($selectedID2['result'] as $i): ?>
                            ...
                            <td hidden>
                                ...
                                <td hidden id="tdIdR"><?php echo $i['customer_id']; ?></td>
                                <td id="tdClIdR"><?php if($i['cl_id']){echo $i['cl_id'];}else{ echo "NO CL ID";}  ?></td>
            ...
            <form action="<?php echo BASE_URL() ?>ecash_send/ecashtocebuana" method="post"  id="frmProceedEcashPadala">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <div class="form-group">
                                <h3>E-CASH TO CEBUANA</h3>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" name="inputRelation" id="inputRelation" placeholder="RELATION TO RECEIVER" value="<?php echo $inputRelation ?>" required/>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" name="inputPurpose" id="inputPurpose" placeholder="PURPOSE OF TRANSACTION" value="<?php echo $inputPurpose ?>" required/>
                            </div>  
                            <div class="form-group">
                            ...
                            <div class="form-group">
                            <input type="text" class="form-control" name="inputAmount" pattern="[0-9]" placeholder="Enter Amount" id="inputAmount" title="Input must be a number or decimal." autocomplete="off" oninput="validate(this)" onkeyup="amountValidate()" onkeypress="return /[0-9]/i.test(event.key)" maxlength="8" required/>
                                <span style="color: red;" id="ammont_err">Minimum amount is P60.00</span>
                                <span style="color: red;" id="ammont_err2">Maximum amount is P40,000.00</span>
                            </div>  
                            <div class="form-group">
            ...
            <div class="row row-stat">
                <div class="col-md-12">
                        <div class="row" id="divSearchSender">
                            <div class="col-md-6">
                                ...
                                <?php if($row['S']==1 && $row['result'][0]['sender_id'] || $rowMessage): ?>
                                    ...
                                    <?php else: ?>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <form name="frmecashpadalasender" action="<?php echo BASE_URL() ?>ecash_send/ecashtocebuana" method="post" id="frmSSeachRemit" >
                                                    <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <?php if ($row['S']==1): ?>
                                                ...
                                                <?php endif ?>
                                                <form name="frmecashpadalabene" action="<?php echo BASE_URL() ?>ecash_send/ecashtocebuana" method="post" id="frmBSeachRemit" >
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <form action="<?php echo BASE_URL() ?>ecash_send/ecashtocebuana" method="post"  id="frmTransacBSP">
                                        ...
                                        <table id="tblSelectedSender"  class="table" cellspacing="0" style="width:100%;">
                                            ...
                                            <?php  foreach ($selectedSender['result'] as $i): ?>
                                                ...
                                                <tr class="tr">
                                                    ...
                                                    <td><?php if($i['cl_id']){echo $i['cl_id'];}else{ echo "NO CL ID";}  ?></td>
                                                    <td><?php if($i['cl_no']){echo $i['cl_no'];}else{ echo "NO CL NUMBER";} ?></td>
                    ...
                    <div id="senderFormData" class="col-md-12" hidden >
                        ...
                        <form action="<?php echo BASE_URL() ?>ecash_send/ecashtocebuana" method="post"  id="frmAddEcashPadalaBeneficiary">
                            <div class="col-md-1"></div>
                            <div class="col-md-10">
                                <div class='col-md-12 text-center'>
                                    <div class="form-group">
                                ...
                                <div id="step1">
                                    ...
                                    <div class='col-md-6'>
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="inputFnameBene" id="inputFnameBene" placeholder="FIRSTNAME" oninput="this.value = this.value.toUpperCase()" onkeypress="return isLetterKey(event)" required/>
                                        </div> 
                                    </div>
                                    <div class='col-md-6'>
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="inputMnameBene" id="inputMnameBene" placeholder="MIDDLENAME" oninput="this.value = this.value.toUpperCase()" onkeypress="return isLetterKey(event)" />
                                        </div> 
                                    </div>
                                    <div class='col-md-8'>
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="inputLnameBene" id="inputLnameBene"  placeholder="LASTNAME" oninput="this.value = this.value.toUpperCase()" onkeypress="return isLetterKey(event)" required/>
                                        </div> 
                                    </div>
                                    <div class='col-md-4'>
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="inpuSuffixBene" id="inpuSuffixBene"  placeholder="SUFFIX" oninput="this.value = this.value.toUpperCase()" onkeypress="return isLetterKey(event)" />
                                        </div> 
                                    </div>
    ...
    <div class="modal fade" id="addModalSender" role="dialog" data-keyboard="false" data-backdrop="static">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <form action="<?php echo BASE_URL() ?>ecash_send/ecashtocebuana" method="post"  id="frmAddEcashPadalaSender" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div id="step1">
                                    <div class='col-md-6'>
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="inputFname" id="inputFname" placeholder="FIRSTNAME" oninput="this.value = this.value.toUpperCase()" onkeypress="return isLetterKey(event)" required/>
                                        </div> 
                                    </div>
                                    <div class='col-md-6'>
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="inputMname" id="inputMname" placeholder="MIDDLENAME"oninput="this.value = this.value.toUpperCase()" onkeypress="return isLetterKey(event)" />
                                        </div> 
                                    </div>
                                    <div class='col-md-8'>
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="inputLname" id="inputLname"  placeholder="LASTNAME" oninput="this.value = this.value.toUpperCase()" onkeypress="return isLetterKey(event)" required/>
                                        </div> 
                                    </div>
                                    <div class='col-md-4'>
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="inpuSuffix" id="inpuSuffix"  placeholder="SUFFIX" oninput="this.value = this.value.toUpperCase()" onkeypress="return isLetterKey(event)" />
                                        </div> 
                                    </div>
                                    ...
                                    <div class='col-md-6'>
                                        <div class="form-group" >
                                            <input type="text" class="form-control" name="inputBirthplace" id="inputBirthplace" placeholder="BIRTH PLACE" oninput="this.value = this.value.toUpperCase()" onkeypress="return isLetterKey(event)" required/>
                                        </div> 
                                    </div>
                                    <div class='col-md-4'>
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="inputOccupation" id="inputOccupation"  placeholder="OCCUPATION" oninput="this.value = this.value.toUpperCase()" onkeypress="return isLetterKey(event)" required/>
                                        </div>
                                    </div>
                                    <div class='col-md-4'>
                                        <div class="form-group">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form name="frmSummaryConfirmation" action="<?php echo BASE_URL() ?>ecash_send/ecashtocebuana" method="post" id="frmSummaryConfirmation" > 
            ...
            <input hidden name="service" id="hiddenService" value="ECASHTOCEBUANA"/>
  ...
  <script type="text/javascript">
    ...
    $('#divRadio input').on('change', function() {
      var selVal = $('input[name=optradio]:checked', '#divRadio').val();
        if(selVal == 1){
            $('#frmSSeachRemit').hide();
            $('#frmSSeachRemitNumber').show();

        }else{  
            $('#frmSSeachRemit').show();
            $('#frmSSeachRemitNumber').hide();
        }
    });
    ...
    $('#frmAddEcashPadalaBeneficiary #btnAddDetailsBene').click(function(){
        let empty1 = false;
        let empty2 = false;
        var idArray1 = [];
        var idArray2 = [];

        $('form#frmAddEcashPadalaBeneficiary').find('input').each(function(){
            if($(this).prop('required')){
                $(this).each(function() {
                    empty1 = $(this).val().length;
                    idArray1.push(empty1);
        ...
        $('form#frmAddEcashPadalaBeneficiary .selOption > option:selected').each(function() {
            if($('form#frmAddEcashPadalaBeneficiary .selOption').is(':visible')){
                if($('form#frmAddEcashPadalaBeneficiary .selOption').prop('required')){
                    empty2 = $(this).val().length;
                    idArray2.push(empty2);
                }
            }
    ...
    var tRelation, tPurpose, tCurrency, tAmount, tCharge,
        idS, fullS, bdateS,
        idR, fullR, bdateR;
    ...
    $('#btnModalTransaction').click(function(){
        ...
        if(tRelation && tPurpose && tCurrency && tAmount){
            waitingDialog.show('Please Wait.', {dialogSize: 'sm', progressType: 'primary'});
            $('#tpass').val('');
            fetchRate();
        }else{
    ...
    function fetchRate(){
        ...
        formData.append('currency_id', tCurrencyID);
        formData.append('amount', tAmount);

        $.ajax({
            url         : '/Ecash_send/fetch_ecashtocebuana_rate',
            type        : 'POST',
            data        : formData,
            processData : false,
            contentType : false,
            success     : function (data) {
                ...
                if(jsonData.S == 1){
                    tCharge = jsonData.SF;
                    var tTotal = jsonData.TA;
                    var tClientIdS, tClientIdR;

                    tClientIdS = $('#tdClIdS').text();
                    tClientIdR = $('#tdClIdR').text();
                    
		            $("#remittanceSummaryModal").modal('show');
                    $('#senderid').val(tClientIdS);
                    $('#sender_name').val(fullS);
                    $('#sender_bdate').val(bdateS);

                    $('#beneid').val(tClientIdR);
                    $('#bene_name').val(fullR);
                        ...
                        if(jsonData.S == 1){
                            ...
                            $.ajax({
                                ...
                                success     : function (data) { 
                                    ...
                                    if(jsonData.S == 1){
                                        $.ajax({
                                            url         : '/Ecash_send/ecashtocebuanaTransacBSP',
                                            type        : 'POST',
                                            data        : formData3,
                                            processData : false,
                                            contentType : false,
