              ...
              <div class="col-md-7">
                  <div class="panel panel-default">
                    <div class="panel-body" style="border: 1px solid #d3d3d3; border-radius:10px; padding: none;"><!--style="background-color: #FF9933;"-->
                        ...
                        <p>Using your availability e-Cash Balance you can convert this to Universal Loadwallet using the form below. </p>
                        <p>Procedure on how to transfer e-Cash Balance to your Universal Loadwallet. </p>
              ...
              <div class="col-xs-6  col-md-6">
                <div class="row">
                    <div class='col-xs-12 col-md-8'>
                        <form name="frmecashtoloadfund" action="<?php echo BASE_URL() ?>ecash_send/loadfund" method="post" id="frmecashsend">
