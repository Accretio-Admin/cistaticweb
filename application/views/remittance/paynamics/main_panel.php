        ...
        <center>
          ...
          <div class="" id="added">
            ...
            <div class="row"id="pending">
              <h2>TRANSACTION HAS BEEN <b><?php if($status == "APPROVED"){ echo "<span style='color:green'>$status</span>";}elseif($status == "DENIED"){echo "<span style='color:red'>$status</span>";} ?></b></h2>
              ...
              <div class="col-md-4"></div>
              <div class="form-group col-md-4 rounded-corner" id="receipt">
                <div class="mt-1 mb-1">
                  ...
                  <div class="receipt-deets">Charge: <span><?php echo $charge ?></span></div>
                  <div class="receipt-deets">Tracking No: <span><?php echo $trackno ?></span></div>
                  <div class="receipt-deets">Message: <span><?php echo $message ?></span></div>
                </div>
              </div>
              <div class="col-md-4"></div>
            </div>
