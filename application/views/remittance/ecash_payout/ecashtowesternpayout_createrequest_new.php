...
<?php 
    ...
    <!-- Paste ContentPanel Here -->
                ...
                <div class="col-md-12">
                    <div class="row">
                      <div class="col-md-6">
                        <?php include 'ecash_payout_createrequest/search_tracking_no.php'; ?>  
                      </div>
                      <br />
                      <div class="row">
                   ...
                   <div class="col-md-12">
                      ...
                      <?php if ($row['S']==1): ?>
                        ...
                        <div class="row" id="stepTwo">
                            <div class="col-md-6">
                                <?php include 'ecash_payout_createrequest/add_sender_beneficiary.php'; ?>  
                                <?php include 'ecash_payout_createrequest/add_payout.php'; ?>  
                            </div>
                        </div>
                      <?php endif; ?>
                    </div>
...
<!-- End of Ifelse IP is not equal to PH -->
        ...
        <?php 
          ...
          if (in_array($user['R'], $reg_codes)): 
        ?>
          <!-- old frmWesternPayout -->
        <?php else: ?>
