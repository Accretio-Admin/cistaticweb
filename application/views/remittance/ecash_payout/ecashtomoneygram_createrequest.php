...
<!-- Paste ContentPanel Here -->
          ...
          <div class="row" style="margin-bottom: 30px;">
            <ul class="nav nav-tabs">
              <li class="active"><a href="<?php echo BASE_URL()?>ecash_payout/ecashtomoneygram_createrequest" style="color: #428bca;"><b>CREATE REQUEST</b></a></li> 
              <li><a href="<?php echo BASE_URL()?>ecash_payout/ecashtomoneygram_payoutlist">PENDING</a></li>   
              <li><a href="<?php echo BASE_URL()?>ecash_payout/ecashtomoneygram_payoutdone">DONE/CANCELLED</a></li>
            </ul>
          </div>
        </div>
        <?php endif; ?>
                      ...
                      <div class="col-md-6">
                        <div class="row">
                          <div class="col-md-12">
                              ...
                              <div class="form-group">
                                <form name="frmecashpadalasender" action="<?php echo BASE_URL() ?>ecash_payout/ecashtomoneygram_createrequest" method="post" id="frmSSeachRemit" >
                                  <div class="row">
                        ...
                        <div class="row">
                          <div class="col-md-12">
                            <div class="form-group">
                              <form name="frmecashpadalabeneficiary" action="<?php echo BASE_URL() ?>ecash_payout/ecashtomoneygram_createrequest" method="post" id="frmBSeachRemit"  >
                                          <div class="row">
                                              <div class='col-xs-12 col-md-12'>
                                                  <div class="row">
                                                     <div class="col-md-10">
                                    ...
                                    <table id="example"  class="table table-bordered" cellspacing="0" style="width:100%;">
                                              ...
                                              <tbody>
                                                ...
                                                <tr class="tr">
                                                    ...
                                                    <td><a id="aFindWestern" data-uniq="<?php echo $i['ids']; ?>" class="btn btn-danger" data-id="<?php echo $type['typeid'].'|PAYOUT'?>" href="#">Select</a></td>
  ...
  <div class="modal fade" id="addModal" role="dialog" data-backdrop="static" data-keyboard="false">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form action="<?php echo BASE_URL() ?>ecash_payout/ecashtomoneygram_createrequest" method="post"  id="frmAddEcashPadala">
            <div class="modal-body">
              <div class="row">
                  <div class="col-md-12">
                          ...
                          <div class='col-md-8' style="padding-left:0px!important">
                             ...
                             <div class="form-group" >
                                 <div class="input-group">
                                  ...
                                  <input type="text" class="form-control pablo" name="inputBdate" id="datetimepicker" placeholder="BIRTHDATE" readonly required/>
                                </div>
...
$("#frmAddEcashPadala").submit(function(e){
  
  if($(".pablo").val() == ""){
    e.preventDefault();
    $("#frmAddEcashPadala").removeAttr("action");
    alert("Birthday field is empty");
    waitingDialog.hide();
  }else{
    var urL = "<?php echo BASE_URL() ?>ecash_payout/ecashtomoneygram_createrequest";
    $('#frmAddEcashPadala').attr('action', urL);
  }
...
<script src="<?php echo BASE_URL()?>assets/script/ecash_moneygram.js"></script>
