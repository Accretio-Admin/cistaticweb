...
<!-- Start of IF ip is equal to PH then proceed -->
                  ...
                  <div class="panel-body">
                    <form name="frmnewyorkbay" action="<?php echo BASE_URL() ?>ecash_payout/newyorkbay" method="post" class="frmclass" id="frmNYBY">
                        ...
                        <div class="form-group text-right">
                            <button type="submit" class="btn btn-primary" name="btnNYBCheck">Submit</button>
                        </div>
                    </form>
                  </div>
                 </div>
              ...
              <div class="contentpanel" style="padding-top: 0px;"> 
                <div class="panel panel-default">
                  ...
                  <div class="panel-body" style="padding-top: 0px;">
                    <form name="frmtransfast" action="<?php echo BASE_URL() ?>ecash_payout/newyorkbay" method="post" class="frmclass" id="frmNYBY">
                    <h4>BENEFICIARY</h4>
                    <div class="form-group">
                        <div class="input-group">
                          <span class="input-group-addon" id="basic-addon1" style="padding-right: 21px;">FIRST NAME:</span>
                          <input type="text" class="form-control" name="inputBeneficiaryFName" id="benefname" value="<?php echo $API['Benefirstname']; ?>"  readonly="">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                          <span class="input-group-addon" id="basic-addon1" style="padding-right: 8px;">MIDDLE NAME:</span>
                          <input type="text" class="form-control" name="inputBeneficiaryMName" id="benemname" value="<?php echo $API['Benemiddlename']; ?>"  readonly="">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                          <span class="input-group-addon" id="basic-addon1" style="padding-right: 26px;">LAST NAME:</span>
                          <input type="text" class="form-control" name="inputBeneficiaryLName" id="benelname" value="<?php echo $API['Benelastname']; ?>"  readonly="">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                    ...
                    <div class="form-group">
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="inputTranstype" id="transtype" value="NEWYORKBAY PAYOUT"  readonly="">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                    ...
                    <div class="form-group">
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="inputAmount" id="principalamount" value="<?php echo $API['Amount']; ?>"  readonly="">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-12 text-right">
                                ...
                                <button name="btnNYBConfirm" class="btn btn-primary"><span class="glyphicon glyphicon-ok-circle"></span>&nbsp;Confirm</button>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <input type="hidden" class="form-control" name="inputTpass" value="<?php echo $row['inputTpass']; ?>" />
                        <input type="hidden" class="form-control" name="inputBeneficiaryName" value="<?php echo $API['Benefirstname'].$API['Benemiddlename'].$API['Benelastname']; ?>" />
                        <input type="hidden" class="form-control" name="inputSessionID" value="<?php echo $API['sessionId']; ?>" />
                        <input type="hidden" class="form-control" name="inputTransType" value="2" />
                    </div>
                    </form>
                  </div>
                </div>
