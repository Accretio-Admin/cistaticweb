                  ...
                  <div class="col-lg-12"> 
                    <div class="row" style="margin-bottom: 30px;">
                      <ul class="nav nav-tabs">
                        ...
                        <li class="active"><a href="<?php echo BASE_URL()?>ecash_payout/ecashtomoneygram_payoutlist" style="color: #428bca;"><b>PENDING</b></a></li>   
                        ...
                        <table class="table table-bordered table-hover" id="example">
                          ...
                          <?php foreach ($results['T_DATA'] as $row): ?>
                            <tr class="prod_row">
                              ...
                              <td><a onclick="return confirm('Check Status?','Ecash to Moneygram')" href="<?php echo BASE_URL() ?>Ecash_payout/ecashtomoneygram_payoutlist/<?php echo $row['trackingNumber'] ?>" class="btn btn-primary" data-toggle="tooltip" title="Click here to check status" style="font-size: 13px;"><?php echo 'Check Status' ?></a></td>
                            </tr>
                          <?php endforeach ?>
                      </tbody>
                        </table>
