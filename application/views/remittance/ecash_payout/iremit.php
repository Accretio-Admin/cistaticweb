...
<!-- Start of IF ip is equal to PH then proceed -->
                    ...
                    <h5 style="font-weight: bold; color: #4169E1;">IREMIT</h5>
                      ...
                      <div class="panel-body">
                        <form name="frmiremit" action="<?php echo BASE_URL() ?>ecash_payout/iremit" method="post" class="frmclass" id="frmIremit">
                    ...
                    <h5 style="font-weight: bold; color: #4169E1;">IREMIT</h5>
                      ...
                      <div class="panel-body">
                        ...
                        <h4>SENDER</h4>
                            ...
                            <div class="form-group">
                              <div class="input-group">
                              <span class="input-group-addon" id="basic-addon1" style="padding-right: 11px;">CONTACT NO.:</span>
                                <input type="text" class="form-control" name="inputMobileNo" value="<?php echo $API['Telno']; ?>"  readonly="">
                              </div>
                            </div>
                        <h4>BENEFICIARY</h4>
                            <div class="form-group">
                                <div class="input-group">
                                  ...
                                  <input type="text" class="form-control" name="inputBeneficiaryName" value="<?php echo $API['Beneficiary']; ?>"  readonly="">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group">
                                  <span style="font-size:18px; padding-right: 165px;">IDENTIFICATION</span>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                  ...
                                  <input type="text" class="form-control" name="inputReferenceNo" id="trackno" value="<?php echo $API['ReferenceID']; ?>"  readonly="">
                                  <input type="text" class="form-control" name="inputTranstype" id="transtype" value="IREMIT PAYOUT"  readonly="">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control" name="inputBeneficiaryFName" id="benefname" value="<?php echo $row['benefname']; ?>"  readonly="">
                                <input type="hidden" class="form-control" name="inputBeneficiaryMName" id="benemname" value="<?php echo $API['bene_mname']; ?>"  readonly="">
                                <input type="hidden" class="form-control" name="inputBeneficiaryLName" id="benelname" value="<?php echo $row['benelname']; ?>"  readonly="">
                            </div>
                        </form>
                      </div>
                   </div>
