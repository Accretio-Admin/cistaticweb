...
// });
    ...
    //console.log('putek');
      ...
      $("#frmWesternPayout").on("submit",function(event){
          ...
          var country = $("#frmWesternPayout #country_iso_payout").val();
          ...
          var branchLocation = 'UNIFIED PRODUCT- QUEZON AVE';
    
          var parameters = {refno:refno, transpass:transpass, sender_id:sender_id, beneficiary_id:beneficiary_id, amount:amount, currency:currency[0], primaryId:primaryId, secondaryId:secondaryId, tertiaryId:tertiaryId, country:country, occupation:occupation, relationbene:relationbene, empname:empname, fundsrc:fundsrc, countrybirth:countrybirth, nationality:nationality, branch_location:branchLocation};
      ...
      $("#frmWesternPayoutSenderBeneficiary").on("submit",function(event){
        event.preventDefault();
        
        //waitingDialog.show('Please Wait..', {dialogSize: 'sm', progressType: 'primary'});
        
        var mtcn = $('input[name=inputMtcn]').val();
        var transpass = $('input[name=inputTpass]').val();
    
        var fnameSs = $('input[name=inputFnameSs]').val();
        var mnameSs = $('input[name=inputMnameSs]').val();
        var lnameSs = $('input[name=inputLnameSs]').val();
        var emailSs = $('input[name=inputEmailSs]').val();
        var mobileSs = $('input[name=inputMobileSs]').val();
        var genderSs = $('select[name=selGenderSs] option:selected').val();
        var addrSs = $('textarea[name=inputAddrSs]').val();
        var bdateSs = $('input[name=inputBdateSs]').val();
        var countrySs = $('select[name=selCountrySs] option:selected').val();
    
        var fnameBb = $('input[name=inputFnameBb]').val();
        var mnameBb = $('input[name=inputMnameBb]').val();
        var lnameBb = $('input[name=inputLnameBb]').val();
        var emailBb = $('input[name=inputEmailBb]').val();
        var mobileBb = $('input[name=inputMobileBb]').val();
        var genderBb = $('select[name=selGenderBb] option:selected').val();
        var addrBb = $('textarea[name=inputAddrBb]').val();
        var bdateBb = $('input[name=inputBdateBb]').val();
        var countryBb = $('select[name=selCountryBb] option:selected').val();
        ...
        $.ajax({
          url: "/Ecash_payout/ecash_to_western_payout_add_sender_beneficiary_request",
          type: "POST",
          data: parameters,
          success: function(data)
          {
            ...
            if (jsondata.S == 1) {
              $("#frmWesternPayout").show();
    
              $('#inputSenderEmail').val(emailSs);
              $('#inputSenderBdate').val(bdateSs);
    
              $('#inputBeneficiaryMiddleName').val(mnameBb);
              $('#inputBeneficiaryAddress').val(addrBb);
              $('#inputBeneficiaryMobile').val(mobileBb);
              $('#inputBeneficiaryEmail').val(emailBb);
              $('#inputBeneficiaryBdate').val(bdateBb);
    
              $('#inputSenderID').val(jsondata.SS);
              $('#inputBeneficiaryID').val(jsondata.BB);
    
              $("#frmWesternPayoutSenderBeneficiary").hide();
            } else {
              alert(jsondata.M);
            }
          }
      ...
      $("#frmWesternSender").on("submit",function(event){
          ...
          var secondaryId = $("#frmWesternSender #selvalidID1_western").val();
          var tertiaryId = $("#frmWesternSender #selvalidID1_western").val();
          ...
          var branchLocation = 'UNIFIED PRODUCT- QUEZON AVE';
          var city = $("#frmWesternSender #inputCity").val();
          var province = $("#frmWesternSender #inputProvince").val();
          var postalCode = $("#frmWesternSender #inputPostalCode").val();
          var positionLevel = $("#frmWesternSender #inputPositionLevel").val();
          var transactionReason = $("#frmWesternSender #inputTransactionReason").val();
          var idCountryIssued = $("#frmWesternSender #inputIdCountryIssued").val();
          var issueDate = `${date.getDate().toString().padStart(2, "0")}${(date.getMonth() + 1).toString().padStart(2, "0")}${date.getFullYear()}`;
          var destinationCountry = $('#inputDestinationCountry').val();
          var destinationCurrency = $('#inputDestinationCurrency').val();
          ...
          var parameters = {
            ...
            id_country_issued: idCountryIssued,
            issue_date: issueDate,
            destination_country_code: destinationCountry,
            destination_currency_code: destinationCurrency,
         ...
         $.ajax({
            ...
            { 
              var jsondata = JSON.parse(data);
                ...
                //frmWesternSenderDetails(jsondata);

                frmWesternSenderApproved(jsondata,transpass);
      ...
      function frmWesternSenderDetails (jsondata) {
        var tn=jsondata.TN;
        var ssId=jsondata.SS;
        var bbId=jsondata.BB;
        var date = new Date();
        date.setDate(date.getDate()-1);
    
        // var branchLocation = $("#frmWesternSender #inputBranchLocation").val();
        ...
        $.ajax({
          type : 'POST',
          data: params,
          url  : "/Ecash_send/ecash_to_western_send_details",
          success : ((data) => {
            var jsondata = JSON.parse(data)
          })
        });  
      ...
      function frmWesternSenderApproved (jsondata,transpass) {
        var tn=jsondata.TN;
        ...
        $.ajax({
          type : 'POST',
          data: params,
          url  : "/Ecash_send/ecash_to_western_send_approved",
          success : ((data) => {
            var jsondata = JSON.parse(data)
          })
        });  
      ...
      function getStateCodes (countryCode) {
        ...
        $.ajax({
          type: 'POST',
          data: params,
          url: '/Ecash_send/ecash_to_western_state_codes',
          success: ((data) => {
            var state_codes = JSON.parse(data)

            for (const [key, value] of Object.entries(state_codes['D'])) {
              $('#inputStateCode').append(new Option(value, key))
            }
          })
        })
      }
     ...
     $("#country_iso").change(function () {
      ...
      function get_country_charge()
      {
        ...
        var bb_country = $('#inputBeneCountry').val();
    
        var parameters = {country:country,amount:amount,currency:currency[0],bb_country:bb_country}; 
    ...
    //console.log(inputBeneficiaryHide);
        ...
        if (data[0] == 1 ) 
        {
          ...
          if (sender.val() != "") {
            ...
            beneficiary.focus();
            inputSenderHide.val(str[0] + "|" + str[1] + "|" + str[2] + "|" + str[3] + "|" + str[4] + "|" + str[5] + "|" + str[6] + "|" + str[7] + "|" + str[8]);
          }
        }
        else if (data[0] == 2)
        {
          ...
          inputBeneficiaryHide.val(str[0] + "|" + str[1] + "|" + str[2] + "|" + str[3] + "|" + str[4] + "|" + str[5] + "|" + str[6] + "|" + str[7] + "|" + str[8]);
        }
      ...
      $('.btnProceedWestern').click(function(){
        ...
        $('#inputBeneCountry').val(inputBeneficiaryHide[9]);
        $('#inputDestinationCountry').val(inputBeneficiaryHide[10][0].toUpperCase() + inputBeneficiaryHide[10].slice(1).toLowerCase());
        
        if (inputBeneficiaryHide[9] == 'DOMESTIC') {
          $('#inputDestinationCurrency').attr('disabled', 'disabled')
          $('#inputDestinationCurrency').val('PHP')
        }

        if (inputBeneficiaryHide[10] == 'UNITED STATES' || inputBeneficiaryHide[10] == 'MEXICO') {
          $('#stateCodeContainer').show()
          $('#inputStateCode').attr('required', true)

          getStateCodes(inputBeneficiaryHide[10] == 'UNITED STATES' ? 'US' : 'MX')
        }
    ...
    function westernfetchpayoutIDs(){
      ...
      if ($("#aFindWestern").val()) {
        var transtype = $("#aFindWestern").val().split('|');
      } else {
        var transtype = $('a[id=aFindWestern]').data('id').split('|');
      }
      ...
      if(transtype[1] != 'PAYOUT'){
        ...
        if ($("#inputBeneficiaryID").val()) {
          var benefname = $("#inputBeneficiaryFirstName").val();
          var benemname = $("#inputBeneficiaryMiddleName").val();
          var benelname = $("#inputBeneficiaryLastName").val();
          var benebdate = $("#inputBeneficiaryBdate").val();
    ...
    //console.log(senderDetails);
      ...
      if(transtype[1] != 'PAYOUT'){
        ...
        if ($("#inputBeneficiaryID").val()) {
          var benefname = $("#inputSenderFirstName").val();
          var benemname = $("#inputSenderMiddleName").val();
          var benelname = $("#inputSenderLastName").val();
          var benebdate = $("#inputSenderFirstName").val();
          ...
          {         
            ...
            var expirable = arrayItem.expirable;
              ...
              if(newidtype == id)
              {
                ...
                //document.getElementById("newidnumber").placeholder = arrayItem.expirable;
              }
    ...
    //console.log(senderDetails);
        ...
        console.log('newidtype2:',newidtype2);
